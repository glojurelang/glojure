...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("github.com/glojurelang/glojure/value.Cycle", reflect.TypeOf((*github_com_glojurelang_glojure_value.Cycle)(nil)).Elem())
	...
	_register("github.com/glojurelang/glojure/value.NewCycle", github_com_glojurelang_glojure_value.NewCycle)
