...
[(letfn* [foo ([x] (bar x))] (foo 42))
{:op :letfn, :env {:ns user, :context :ctx/expr, :top-level true}, :form (letfn* [foo ([x] (bar x))] (foo 42)), :bindings ({:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn, :init {:op :invoke, :form ([x] (bar x)), :fn {:op :vector, :form [x], :items [{:op :maybe-class, :class x, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn}}}, :form x}], :children [:items]}, :args [{:op :invoke, :form (bar x), :fn {:op :maybe-class, :class bar, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn}}}, :form bar}, :args [{:op :maybe-class, :class x, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn}}}, :form x}], :meta {:file "<unknown-file>", :line 56, :column 20, :end-line 56, :end-column 26}, :children [:fn :args]}], :meta {:file "<unknown-file>", :line 56, :column 15, :end-line 56, :end-column 27}, :children [:fn :args]}, :children [:init]}), :body {:op :do, :form (do (foo 42)), :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :name foo, :form foo, :local :letfn, :init {:op :invoke, :form ([x] (bar x)), :fn {:op :vector, :form [x], :items [{:op :maybe-class, :class x, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn}}}, :form x}], :children [:items]}, :args [{:op :invoke, :form (bar x), :fn {:op :maybe-class, :class bar, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn}}}, :form bar}, :args [{:op :maybe-class, :class x, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn}}}, :form x}], :meta {:file "<unknown-file>", :line 56, :column 20, :end-line 56, :end-column 26}, :children [:fn :args]}], :meta {:file "<unknown-file>", :line 56, :column 15, :end-line 56, :end-column 27}, :children [:fn :args]}, :children [:init]}}}, :statements [], :ret {:op :invoke, :form (foo 42), :fn {:op :local, :name foo, :form foo, :local :letfn, :children [], :assignable? false, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :name foo, :form foo, :local :letfn, :init {:op :invoke, :form ([x] (bar x)), :fn {:op :vector, :form [x], :items [{:op :maybe-class, :class x, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn}}}, :form x}], :children [:items]}, :args [{:op :invoke, :form (bar x), :fn {:op :maybe-class, :class bar, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn}}}, :form bar}, :args [{:op :maybe-class, :class x, :env {:ns user, :context :ctx/expr, :top-level true, :locals {foo {:op :binding, :env {:ns user, :context :ctx/expr, :top-level true}, :name foo, :form foo, :local :letfn}}}, :form x}], :meta {:file "<unknown-file>", :line 56, :column 20, :end-line 56, :end-column 26}, :children [:fn :args]}], :meta {:file "<unknown-file>", :line 56, :column 15, :end-line 56, :end-column 27}, :children [:fn :args]}, :children [:init]}}}}, :args [{:op :const, :form 42, :type :number, :val 42, :literal? true}], :meta {:file "<unknown-file>", :line 56, :column 30, :end-line 56, :end-column 37}, :children [:fn :args]}, :children [:statements :ret], :body? true}, :children [:bindings :body]}]
`
