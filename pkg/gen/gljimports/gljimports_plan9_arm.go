...
func RegisterImports(_register func(string, interface{})) {
	...
	// package syscall
	////////////////////////////////////////
	_register("syscall.Await", syscall.Await)
	...
	_register("syscall.Create", syscall.Create)
	_register("syscall.DMAPPEND", syscall.DMAPPEND)
	_register("syscall.DMAUTH", syscall.DMAUTH)
	_register("syscall.DMDIR", uint32(syscall.DMDIR))
	_register("syscall.DMEXCL", syscall.DMEXCL)
	_register("syscall.DMEXEC", syscall.DMEXEC)
	_register("syscall.DMMOUNT", syscall.DMMOUNT)
	_register("syscall.DMREAD", syscall.DMREAD)
	_register("syscall.DMTMP", syscall.DMTMP)
	_register("syscall.DMWRITE", syscall.DMWRITE)
	_register("syscall.Dir", reflect.TypeOf((*syscall.Dir)(nil)).Elem())
	_register("syscall.*Dir", reflect.TypeOf((*syscall.Dir)(nil)))
	...
	_register("syscall.EPLAN9", syscall.EPLAN9)
	_register("syscall.ERRMAX", syscall.ERRMAX)
	...
	_register("syscall.ErrBadName", syscall.ErrBadName)
	_register("syscall.ErrBadStat", syscall.ErrBadStat)
	_register("syscall.ErrShortStat", syscall.ErrShortStat)
	_register("syscall.ErrorString", reflect.TypeOf((*syscall.ErrorString)(nil)).Elem())
	_register("syscall.Exec", syscall.Exec)
	_register("syscall.Exit", syscall.Exit)
	_register("syscall.Fchdir", syscall.Fchdir)
	_register("syscall.Fd2path", syscall.Fd2path)
	_register("syscall.Fixwd", syscall.Fixwd)
	...
	_register("syscall.Fwstat", syscall.Fwstat)
	...
	_register("syscall.MAFTER", syscall.MAFTER)
	_register("syscall.MBEFORE", syscall.MBEFORE)
	_register("syscall.MCACHE", syscall.MCACHE)
	_register("syscall.MCREATE", syscall.MCREATE)
	_register("syscall.MMASK", syscall.MMASK)
	_register("syscall.MORDER", syscall.MORDER)
	_register("syscall.MREPL", syscall.MREPL)
	_register("syscall.Mkdir", syscall.Mkdir)
	_register("syscall.Mount", syscall.Mount)
	_register("syscall.NewError", syscall.NewError)
	_register("syscall.Note", reflect.TypeOf((*syscall.Note)(nil)).Elem())
	...
	_register("syscall.QTAPPEND", syscall.QTAPPEND)
	_register("syscall.QTAUTH", syscall.QTAUTH)
	_register("syscall.QTDIR", syscall.QTDIR)
	_register("syscall.QTEXCL", syscall.QTEXCL)
	_register("syscall.QTFILE", syscall.QTFILE)
	_register("syscall.QTMOUNT", syscall.QTMOUNT)
	_register("syscall.QTTMP", syscall.QTTMP)
	_register("syscall.Qid", reflect.TypeOf((*syscall.Qid)(nil)).Elem())
	_register("syscall.*Qid", reflect.TypeOf((*syscall.Qid)(nil)))
	_register("syscall.RFCENVG", syscall.RFCENVG)
	_register("syscall.RFCFDG", syscall.RFCFDG)
	_register("syscall.RFCNAMEG", syscall.RFCNAMEG)
	_register("syscall.RFENVG", syscall.RFENVG)
	_register("syscall.RFFDG", syscall.RFFDG)
	_register("syscall.RFMEM", syscall.RFMEM)
	_register("syscall.RFNAMEG", syscall.RFNAMEG)
	_register("syscall.RFNOMNT", syscall.RFNOMNT)
	_register("syscall.RFNOTEG", syscall.RFNOTEG)
	_register("syscall.RFNOWAIT", syscall.RFNOWAIT)
	_register("syscall.RFPROC", syscall.RFPROC)
	_register("syscall.RFREND", syscall.RFREND)
	...
	_register("syscall.Remove", syscall.Remove)
	...
	_register("syscall.STATFIXLEN", syscall.STATFIXLEN)
	_register("syscall.STATMAX", syscall.STATMAX)
	_register("syscall.SYS_ALARM", syscall.SYS_ALARM)
	_register("syscall.SYS_AWAIT", syscall.SYS_AWAIT)
	_register("syscall.SYS_BIND", syscall.SYS_BIND)
	_register("syscall.SYS_BRK_", syscall.SYS_BRK_)
	_register("syscall.SYS_CHDIR", syscall.SYS_CHDIR)
	_register("syscall.SYS_CLOSE", syscall.SYS_CLOSE)
	_register("syscall.SYS_CREATE", syscall.SYS_CREATE)
	_register("syscall.SYS_DUP", syscall.SYS_DUP)
	_register("syscall.SYS_ERRSTR", syscall.SYS_ERRSTR)
	_register("syscall.SYS_EXEC", syscall.SYS_EXEC)
	_register("syscall.SYS_EXITS", syscall.SYS_EXITS)
	_register("syscall.SYS_FAUTH", syscall.SYS_FAUTH)
	_register("syscall.SYS_FD2PATH", syscall.SYS_FD2PATH)
	_register("syscall.SYS_FSTAT", syscall.SYS_FSTAT)
	_register("syscall.SYS_FVERSION", syscall.SYS_FVERSION)
	_register("syscall.SYS_FWSTAT", syscall.SYS_FWSTAT)
	_register("syscall.SYS_MOUNT", syscall.SYS_MOUNT)
	_register("syscall.SYS_NOTED", syscall.SYS_NOTED)
	_register("syscall.SYS_NOTIFY", syscall.SYS_NOTIFY)
	_register("syscall.SYS_NSEC", syscall.SYS_NSEC)
	_register("syscall.SYS_OPEN", syscall.SYS_OPEN)
	_register("syscall.SYS_OSEEK", syscall.SYS_OSEEK)
	...
	_register("syscall.SYS_REMOVE", syscall.SYS_REMOVE)
	_register("syscall.SYS_RENDEZVOUS", syscall.SYS_RENDEZVOUS)
	_register("syscall.SYS_RFORK", syscall.SYS_RFORK)
	_register("syscall.SYS_SEEK", syscall.SYS_SEEK)
	_register("syscall.SYS_SEGATTACH", syscall.SYS_SEGATTACH)
	_register("syscall.SYS_SEGBRK", syscall.SYS_SEGBRK)
	_register("syscall.SYS_SEGDETACH", syscall.SYS_SEGDETACH)
	_register("syscall.SYS_SEGFLUSH", syscall.SYS_SEGFLUSH)
	_register("syscall.SYS_SEGFREE", syscall.SYS_SEGFREE)
	_register("syscall.SYS_SEMACQUIRE", syscall.SYS_SEMACQUIRE)
	_register("syscall.SYS_SEMRELEASE", syscall.SYS_SEMRELEASE)
	_register("syscall.SYS_SLEEP", syscall.SYS_SLEEP)
	_register("syscall.SYS_STAT", syscall.SYS_STAT)
	_register("syscall.SYS_SYSR1", syscall.SYS_SYSR1)
	_register("syscall.SYS_TSEMACQUIRE", syscall.SYS_TSEMACQUIRE)
	_register("syscall.SYS_UNMOUNT", syscall.SYS_UNMOUNT)
	_register("syscall.SYS_WSTAT", syscall.SYS_WSTAT)
	...
	_register("syscall.UnmarshalDir", syscall.UnmarshalDir)
	_register("syscall.Unmount", syscall.Unmount)
	_register("syscall.Unsetenv", syscall.Unsetenv)
	_register("syscall.WaitProcess", syscall.WaitProcess)
	_register("syscall.Waitmsg", reflect.TypeOf((*syscall.Waitmsg)(nil)).Elem())
	_register("syscall.*Waitmsg", reflect.TypeOf((*syscall.Waitmsg)(nil)))
	_register("syscall.Write", syscall.Write)
	_register("syscall.Wstat", syscall.Wstat)
