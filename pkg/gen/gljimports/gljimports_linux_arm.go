...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("syscall.ELF_NGREG", syscall.ELF_NGREG)
	_register("syscall.ELF_PRARGSZ", syscall.ELF_PRARGSZ)
	...
	_register("syscall.PR_CLEAR_SECCOMP_FILTER", syscall.PR_CLEAR_SECCOMP_FILTER)
	...
	_register("syscall.PR_GET_SECCOMP_FILTER", syscall.PR_GET_SECCOMP_FILTER)
	...
	_register("syscall.PR_SECCOMP_FILTER_EVENT", syscall.PR_SECCOMP_FILTER_EVENT)
	_register("syscall.PR_SECCOMP_FILTER_SYSCALL", syscall.PR_SECCOMP_FILTER_SYSCALL)
	...
	_register("syscall.PR_SET_SECCOMP_FILTER", syscall.PR_SET_SECCOMP_FILTER)
	...
	_register("syscall.PTRACE_GETCRUNCHREGS", syscall.PTRACE_GETCRUNCHREGS)
	...
	_register("syscall.PTRACE_GETHBPREGS", syscall.PTRACE_GETHBPREGS)
	...
	_register("syscall.PTRACE_GETVFPREGS", syscall.PTRACE_GETVFPREGS)
	_register("syscall.PTRACE_GETWMMXREGS", syscall.PTRACE_GETWMMXREGS)
	...
	_register("syscall.PTRACE_SETCRUNCHREGS", syscall.PTRACE_SETCRUNCHREGS)
	_register("syscall.PTRACE_SETFPREGS", syscall.PTRACE_SETFPREGS)
	_register("syscall.PTRACE_SETHBPREGS", syscall.PTRACE_SETHBPREGS)
	...
	_register("syscall.PTRACE_SETVFPREGS", syscall.PTRACE_SETVFPREGS)
	_register("syscall.PTRACE_SETWMMXREGS", syscall.PTRACE_SETWMMXREGS)
	_register("syscall.PTRACE_SET_SYSCALL", syscall.PTRACE_SET_SYSCALL)
	...
	_register("syscall.PT_DATA_ADDR", syscall.PT_DATA_ADDR)
	_register("syscall.PT_TEXT_ADDR", syscall.PT_TEXT_ADDR)
	_register("syscall.PT_TEXT_END_ADDR", syscall.PT_TEXT_END_ADDR)
	...
	_register("syscall.SYS_ARM_FADVISE64_64", syscall.SYS_ARM_FADVISE64_64)
	_register("syscall.SYS_ARM_SYNC_FILE_RANGE", syscall.SYS_ARM_SYNC_FILE_RANGE)
	...
	_register("syscall.SYS_OABI_SYSCALL_BASE", syscall.SYS_OABI_SYSCALL_BASE)
	...
	_register("syscall.SYS_SYSCALL_BASE", syscall.SYS_SYSCALL_BASE)
