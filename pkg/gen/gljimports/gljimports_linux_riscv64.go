...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("syscall.AF_IB", syscall.AF_IB)
	...
	_register("syscall.AF_KCM", syscall.AF_KCM)
	...
	_register("syscall.AF_MPLS", syscall.AF_MPLS)
	...
	_register("syscall.EPOLLEXCLUSIVE", syscall.EPOLLEXCLUSIVE)
	...
	_register("syscall.Fstatat", syscall.Fstatat)
	...
	_register("syscall.IPPROTO_MPLS", syscall.IPPROTO_MPLS)
	...
	_register("syscall.IPV6_PATHMTU", syscall.IPV6_PATHMTU)
	...
	_register("syscall.IPV6_RECVPATHMTU", syscall.IPV6_RECVPATHMTU)
	...
	_register("syscall.IP_BIND_ADDRESS_NO_PORT", syscall.IP_BIND_ADDRESS_NO_PORT)
	_register("syscall.IP_BLOCK_SOURCE", syscall.IP_BLOCK_SOURCE)
	_register("syscall.IP_CHECKSUM", syscall.IP_CHECKSUM)
	...
	_register("syscall.MCL_ONFAULT", syscall.MCL_ONFAULT)
	...
	_register("syscall.MSG_BATCH", syscall.MSG_BATCH)
	...
	_register("syscall.MS_LAZYTIME", syscall.MS_LAZYTIME)
	...
	_register("syscall.SOL_ALG", syscall.SOL_ALG)
	_register("syscall.SOL_ATM", syscall.SOL_ATM)
	_register("syscall.SOL_BLUETOOTH", syscall.SOL_BLUETOOTH)
	_register("syscall.SOL_CAIF", syscall.SOL_CAIF)
	_register("syscall.SOL_DCCP", syscall.SOL_DCCP)
	...
	_register("syscall.SOL_IUCV", syscall.SOL_IUCV)
	_register("syscall.SOL_KCM", syscall.SOL_KCM)
	_register("syscall.SOL_LLC", syscall.SOL_LLC)
	_register("syscall.SOL_NETBEUI", syscall.SOL_NETBEUI)
	_register("syscall.SOL_NETLINK", syscall.SOL_NETLINK)
	_register("syscall.SOL_NFC", syscall.SOL_NFC)
	_register("syscall.SOL_PACKET", syscall.SOL_PACKET)
	_register("syscall.SOL_PNPIPE", syscall.SOL_PNPIPE)
	_register("syscall.SOL_PPPOL2TP", syscall.SOL_PPPOL2TP)
	_register("syscall.SOL_RAW", syscall.SOL_RAW)
	_register("syscall.SOL_RDS", syscall.SOL_RDS)
	_register("syscall.SOL_RXRPC", syscall.SOL_RXRPC)
	_register("syscall.SOL_SOCKET", syscall.SOL_SOCKET)
	_register("syscall.SOL_TCP", syscall.SOL_TCP)
	_register("syscall.SOL_TIPC", syscall.SOL_TIPC)
	...
	_register("syscall.SYS_ARCH_SPECIFIC_SYSCALL", syscall.SYS_ARCH_SPECIFIC_SYSCALL)
	...
	_register("syscall.SYS_FSTATAT", syscall.SYS_FSTATAT)
	...
	_register("syscall.SYS_SEMTIMEDOP", syscall.SYS_SEMTIMEDOP)
	...
	_register("syscall.TCP_CC_INFO", syscall.TCP_CC_INFO)
	...
	_register("syscall.TCP_NOTSENT_LOWAT", syscall.TCP_NOTSENT_LOWAT)
	...
	_register("syscall.TCP_SAVED_SYN", syscall.TCP_SAVED_SYN)
	_register("syscall.TCP_SAVE_SYN", syscall.TCP_SAVE_SYN)
