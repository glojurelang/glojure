...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("syscall.AF_UTUN", syscall.AF_UTUN)
	...
	_register("syscall.EQFULL", syscall.EQFULL)
	...
	_register("syscall.F_FINDSIGS", syscall.F_FINDSIGS)
	...
	_register("syscall.F_GETCODEDIR", syscall.F_GETCODEDIR)
	...
	_register("syscall.F_GETPROTECTIONLEVEL", syscall.F_GETPROTECTIONLEVEL)
	...
	_register("syscall.F_SETLKWTIMEOUT", syscall.F_SETLKWTIMEOUT)
	...
	_register("syscall.F_SINGLE_WRITER", syscall.F_SINGLE_WRITER)
	_register("syscall.F_THAW_FS", syscall.F_THAW_FS)
	_register("syscall.F_TRANSCODEKEY", syscall.F_TRANSCODEKEY)
	...
	_register("syscall.NOTE_BACKGROUND", syscall.NOTE_BACKGROUND)
	_register("syscall.NOTE_CHILD", syscall.NOTE_CHILD)
	_register("syscall.NOTE_CRITICAL", syscall.NOTE_CRITICAL)
	...
	_register("syscall.NOTE_EXIT_CSERROR", syscall.NOTE_EXIT_CSERROR)
	_register("syscall.NOTE_EXIT_DECRYPTFAIL", syscall.NOTE_EXIT_DECRYPTFAIL)
	_register("syscall.NOTE_EXIT_DETAIL", syscall.NOTE_EXIT_DETAIL)
	_register("syscall.NOTE_EXIT_DETAIL_MASK", syscall.NOTE_EXIT_DETAIL_MASK)
	_register("syscall.NOTE_EXIT_MEMORY", syscall.NOTE_EXIT_MEMORY)
	_register("syscall.NOTE_EXIT_REPARENTED", syscall.NOTE_EXIT_REPARENTED)
	...
	_register("syscall.NOTE_LEEWAY", syscall.NOTE_LEEWAY)
	...
	_register("syscall.O_DP_GETRAWENCRYPTED", syscall.O_DP_GETRAWENCRYPTED)
	...
	_register("syscall.RLIMIT_CPU_USAGE_MONITOR", syscall.RLIMIT_CPU_USAGE_MONITOR)
	...
	_register("syscall.RTF_PROXY", syscall.RTF_PROXY)
	_register("syscall.RTF_REJECT", syscall.RTF_REJECT)
	_register("syscall.RTF_ROUTER", syscall.RTF_ROUTER)
	...
	_register("syscall.SO_NUMRCVPKT", syscall.SO_NUMRCVPKT)
	...
	_register("syscall.SYS_CSOPS_AUDITTOKEN", syscall.SYS_CSOPS_AUDITTOKEN)
	...
	_register("syscall.SYS_KAS_INFO", syscall.SYS_KAS_INFO)
	...
	_register("syscall.SYS_LEDGER", syscall.SYS_LEDGER)
	...
	_register("syscall.SYS_OPEN_DPROTECTED_NP", syscall.SYS_OPEN_DPROTECTED_NP)
	...
	_register("syscall.TCP_ENABLE_ECN", syscall.TCP_ENABLE_ECN)
	...
	_register("syscall.TCP_SENDMOREACKS", syscall.TCP_SENDMOREACKS)
