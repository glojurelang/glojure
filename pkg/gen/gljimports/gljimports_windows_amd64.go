...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("syscall.CERT_E_CN_NO_MATCH", syscall.CERT_E_CN_NO_MATCH)
	_register("syscall.CERT_E_EXPIRED", syscall.CERT_E_EXPIRED)
	_register("syscall.CERT_E_PURPOSE", syscall.CERT_E_PURPOSE)
	_register("syscall.CERT_E_ROLE", syscall.CERT_E_ROLE)
	_register("syscall.CERT_E_UNTRUSTEDROOT", syscall.CERT_E_UNTRUSTEDROOT)
	...
	_register("syscall.CRYPT_VERIFYCONTEXT", syscall.CRYPT_VERIFYCONTEXT)
	...
	_register("syscall.GENERIC_READ", syscall.GENERIC_READ)
	...
	_register("syscall.HKEY_CLASSES_ROOT", syscall.HKEY_CLASSES_ROOT)
	_register("syscall.HKEY_CURRENT_CONFIG", syscall.HKEY_CURRENT_CONFIG)
	_register("syscall.HKEY_CURRENT_USER", syscall.HKEY_CURRENT_USER)
	_register("syscall.HKEY_DYN_DATA", syscall.HKEY_DYN_DATA)
	_register("syscall.HKEY_LOCAL_MACHINE", syscall.HKEY_LOCAL_MACHINE)
	_register("syscall.HKEY_PERFORMANCE_DATA", syscall.HKEY_PERFORMANCE_DATA)
	_register("syscall.HKEY_USERS", syscall.HKEY_USERS)
	...
	_register("syscall.INFINITE", syscall.INFINITE)
	_register("syscall.INVALID_FILE_ATTRIBUTES", syscall.INVALID_FILE_ATTRIBUTES)
	_register("syscall.IOC_IN", syscall.IOC_IN)
	_register("syscall.IOC_INOUT", syscall.IOC_INOUT)
	...
	_register("syscall.IO_REPARSE_TAG_SYMLINK", syscall.IO_REPARSE_TAG_SYMLINK)
	...
	_register("syscall.SIO_GET_EXTENSION_FUNCTION_POINTER", syscall.SIO_GET_EXTENSION_FUNCTION_POINTER)
	_register("syscall.SIO_GET_INTERFACE_LIST", syscall.SIO_GET_INTERFACE_LIST)
	_register("syscall.SIO_KEEPALIVE_VALS", syscall.SIO_KEEPALIVE_VALS)
	_register("syscall.SIO_UDP_CONNRESET", syscall.SIO_UDP_CONNRESET)
	...
	_register("syscall.TH32CS_INHERIT", syscall.TH32CS_INHERIT)
	...
	_register("syscall.WAIT_FAILED", syscall.WAIT_FAILED)
