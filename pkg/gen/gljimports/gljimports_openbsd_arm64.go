...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("syscall.AF_ENCAP", syscall.AF_ENCAP)
	...
	_register("syscall.BIOCGDIRFILT", syscall.BIOCGDIRFILT)
	...
	_register("syscall.BIOCGFILDROP", syscall.BIOCGFILDROP)
	...
	_register("syscall.BIOCSDIRFILT", syscall.BIOCSDIRFILT)
	...
	_register("syscall.BIOCSFILDROP", syscall.BIOCSFILDROP)
	...
	_register("syscall.BPF_DIRECTION_IN", syscall.BPF_DIRECTION_IN)
	_register("syscall.BPF_DIRECTION_OUT", syscall.BPF_DIRECTION_OUT)
	_register("syscall.BPF_DIV", syscall.BPF_DIV)
	_register("syscall.BPF_FILDROP_CAPTURE", syscall.BPF_FILDROP_CAPTURE)
	_register("syscall.BPF_FILDROP_DROP", syscall.BPF_FILDROP_DROP)
	_register("syscall.BPF_FILDROP_PASS", syscall.BPF_FILDROP_PASS)
	...
	_register("syscall.DIOCOSFPFLUSH", syscall.DIOCOSFPFLUSH)
	...
	_register("syscall.DLT_OPENFLOW", syscall.DLT_OPENFLOW)
	...
	_register("syscall.DLT_USBPCAP", syscall.DLT_USBPCAP)
	...
	_register("syscall.EIPSEC", syscall.EIPSEC)
	...
	_register("syscall.EMT_TAGOVF", syscall.EMT_TAGOVF)
	_register("syscall.EMUL_ENABLED", syscall.EMUL_ENABLED)
	_register("syscall.EMUL_NATIVE", syscall.EMUL_NATIVE)
	_register("syscall.ENAMETOOLONG", syscall.ENAMETOOLONG)
	_register("syscall.ENDRUNDISC", syscall.ENDRUNDISC)
	...
	_register("syscall.ETHERTYPE_AOE", syscall.ETHERTYPE_AOE)
	...
	_register("syscall.ETHERTYPE_LLDP", syscall.ETHERTYPE_LLDP)
	...
	_register("syscall.ETHERTYPE_PBB", syscall.ETHERTYPE_PBB)
	...
	_register("syscall.ETHERTYPE_QINQ", syscall.ETHERTYPE_QINQ)
	...
	_register("syscall.ETHERTYPE_SLOW", syscall.ETHERTYPE_SLOW)
	...
	_register("syscall.ETHER_ALIGN", syscall.ETHER_ALIGN)
	...
	_register("syscall.ETHER_MAX_DIX_LEN", syscall.ETHER_MAX_DIX_LEN)
	_register("syscall.ETHER_MAX_HARDMTU_LEN", syscall.ETHER_MAX_HARDMTU_LEN)
	...
	_register("syscall.EVFILT_DEVICE", syscall.EVFILT_DEVICE)
	...
	_register("syscall.EVL_ENCAPLEN", syscall.EVL_ENCAPLEN)
	_register("syscall.EVL_PRIO_BITS", syscall.EVL_PRIO_BITS)
	_register("syscall.EVL_PRIO_MAX", syscall.EVL_PRIO_MAX)
	_register("syscall.EVL_VLID_MASK", syscall.EVL_VLID_MASK)
	_register("syscall.EVL_VLID_MAX", syscall.EVL_VLID_MAX)
	_register("syscall.EVL_VLID_MIN", syscall.EVL_VLID_MIN)
	_register("syscall.EVL_VLID_NULL", syscall.EVL_VLID_NULL)
	...
	_register("syscall.F_ISATTY", syscall.F_ISATTY)
	...
	_register("syscall.IFT_BLUETOOTH", syscall.IFT_BLUETOOTH)
	...
	_register("syscall.IFT_DUMMY", syscall.IFT_DUMMY)
	...
	_register("syscall.IFT_MBIM", syscall.IFT_MBIM)
	...
	_register("syscall.IFT_PFLOW", syscall.IFT_PFLOW)
	...
	_register("syscall.IN_RFC3021_HOST", syscall.IN_RFC3021_HOST)
	_register("syscall.IN_RFC3021_NET", syscall.IN_RFC3021_NET)
	_register("syscall.IN_RFC3021_NSHIFT", syscall.IN_RFC3021_NSHIFT)
	...
	_register("syscall.IPV6_AUTH_LEVEL", syscall.IPV6_AUTH_LEVEL)
	...
	_register("syscall.IPV6_ESP_NETWORK_LEVEL", syscall.IPV6_ESP_NETWORK_LEVEL)
	_register("syscall.IPV6_ESP_TRANS_LEVEL", syscall.IPV6_ESP_TRANS_LEVEL)
	...
	_register("syscall.IPV6_IPCOMP_LEVEL", syscall.IPV6_IPCOMP_LEVEL)
	...
	_register("syscall.IPV6_MINHOPCOUNT", syscall.IPV6_MINHOPCOUNT)
	...
	_register("syscall.IPV6_OPTIONS", syscall.IPV6_OPTIONS)
	_register("syscall.IPV6_PATHMTU", syscall.IPV6_PATHMTU)
	_register("syscall.IPV6_PIPEX", syscall.IPV6_PIPEX)
	...
	_register("syscall.IPV6_RECVDSTPORT", syscall.IPV6_RECVDSTPORT)
	...
	_register("syscall.IPV6_RTABLE", syscall.IPV6_RTABLE)
	...
	_register("syscall.IP_AUTH_LEVEL", syscall.IP_AUTH_LEVEL)
	...
	_register("syscall.IP_ESP_NETWORK_LEVEL", syscall.IP_ESP_NETWORK_LEVEL)
	_register("syscall.IP_ESP_TRANS_LEVEL", syscall.IP_ESP_TRANS_LEVEL)
	_register("syscall.IP_HDRINCL", syscall.IP_HDRINCL)
	_register("syscall.IP_IPCOMP_LEVEL", syscall.IP_IPCOMP_LEVEL)
	_register("syscall.IP_IPDEFTTL", syscall.IP_IPDEFTTL)
	_register("syscall.IP_IPSECFLOWINFO", syscall.IP_IPSECFLOWINFO)
	_register("syscall.IP_IPSEC_LOCAL_AUTH", syscall.IP_IPSEC_LOCAL_AUTH)
	_register("syscall.IP_IPSEC_LOCAL_CRED", syscall.IP_IPSEC_LOCAL_CRED)
	_register("syscall.IP_IPSEC_LOCAL_ID", syscall.IP_IPSEC_LOCAL_ID)
	_register("syscall.IP_IPSEC_REMOTE_AUTH", syscall.IP_IPSEC_REMOTE_AUTH)
	_register("syscall.IP_IPSEC_REMOTE_CRED", syscall.IP_IPSEC_REMOTE_CRED)
	_register("syscall.IP_IPSEC_REMOTE_ID", syscall.IP_IPSEC_REMOTE_ID)
	...
	_register("syscall.IP_PIPEX", syscall.IP_PIPEX)
	...
	_register("syscall.IP_RECVDSTPORT", syscall.IP_RECVDSTPORT)
	...
	_register("syscall.IP_RECVRTABLE", syscall.IP_RECVRTABLE)
	...
	_register("syscall.IP_RTABLE", syscall.IP_RTABLE)
	...
	_register("syscall.LCNT_OVERLOAD_FLUSH", syscall.LCNT_OVERLOAD_FLUSH)
	...
	_register("syscall.MAP_CONCEAL", syscall.MAP_CONCEAL)
	...
	_register("syscall.MAP_FLAGMASK", syscall.MAP_FLAGMASK)
	...
	_register("syscall.MAP_INHERIT_ZERO", syscall.MAP_INHERIT_ZERO)
	...
	_register("syscall.*Mclpool", reflect.TypeOf((*syscall.Mclpool)(nil)))
	...
	_register("syscall.NET_RT_IFNAMES", syscall.NET_RT_IFNAMES)
	_register("syscall.NET_RT_MAXID", syscall.NET_RT_MAXID)
	_register("syscall.NET_RT_STATS", syscall.NET_RT_STATS)
	_register("syscall.NET_RT_TABLE", syscall.NET_RT_TABLE)
	_register("syscall.NOFLSH", syscall.NOFLSH)
	_register("syscall.NOTE_ATTRIB", syscall.NOTE_ATTRIB)
	_register("syscall.NOTE_CHANGE", syscall.NOTE_CHANGE)
	_register("syscall.NOTE_CHILD", syscall.NOTE_CHILD)
	_register("syscall.NOTE_DELETE", syscall.NOTE_DELETE)
	_register("syscall.NOTE_EOF", syscall.NOTE_EOF)
	...
	_register("syscall.NOTE_TRUNCATE", syscall.NOTE_TRUNCATE)
	...
	_register("syscall.PF_FLUSH", syscall.PF_FLUSH)
	...
	_register("syscall.RTAX_BFD", syscall.RTAX_BFD)
	_register("syscall.RTAX_BRD", syscall.RTAX_BRD)
	_register("syscall.RTAX_DNS", syscall.RTAX_DNS)
	...
	_register("syscall.RTAX_LABEL", syscall.RTAX_LABEL)
	_register("syscall.RTAX_MAX", syscall.RTAX_MAX)
	_register("syscall.RTAX_NETMASK", syscall.RTAX_NETMASK)
	_register("syscall.RTAX_SEARCH", syscall.RTAX_SEARCH)
	_register("syscall.RTAX_SRC", syscall.RTAX_SRC)
	_register("syscall.RTAX_SRCMASK", syscall.RTAX_SRCMASK)
	_register("syscall.RTAX_STATIC", syscall.RTAX_STATIC)
	_register("syscall.RTA_AUTHOR", syscall.RTA_AUTHOR)
	_register("syscall.RTA_BFD", syscall.RTA_BFD)
	_register("syscall.RTA_BRD", syscall.RTA_BRD)
	_register("syscall.RTA_DNS", syscall.RTA_DNS)
	...
	_register("syscall.RTF_MPATH", syscall.RTF_MPATH)
	_register("syscall.RTF_MPLS", syscall.RTF_MPLS)
	_register("syscall.RTF_MULTICAST", syscall.RTF_MULTICAST)
	_register("syscall.RTF_PERMANENT_ARP", syscall.RTF_PERMANENT_ARP)
	...
	_register("syscall.RTF_USETRAILERS", syscall.RTF_USETRAILERS)
	_register("syscall.RTM_80211INFO", syscall.RTM_80211INFO)
	_register("syscall.RTM_ADD", syscall.RTM_ADD)
	_register("syscall.RTM_BFD", syscall.RTM_BFD)
	_register("syscall.RTM_CHANGE", syscall.RTM_CHANGE)
	_register("syscall.RTM_CHGADDRATTR", syscall.RTM_CHGADDRATTR)
	_register("syscall.RTM_DELADDR", syscall.RTM_DELADDR)
	_register("syscall.RTM_DELETE", syscall.RTM_DELETE)
	_register("syscall.RTM_DESYNC", syscall.RTM_DESYNC)
	...
	_register("syscall.RT_TABLEID_BITS", syscall.RT_TABLEID_BITS)
	_register("syscall.RT_TABLEID_MASK", syscall.RT_TABLEID_MASK)
	_register("syscall.RT_TABLEID_MAX", syscall.RT_TABLEID_MAX)
	...
	_register("syscall.SIOCBRDGADD", syscall.SIOCBRDGADD)
	_register("syscall.SIOCBRDGADDL", syscall.SIOCBRDGADDL)
	_register("syscall.SIOCBRDGADDS", syscall.SIOCBRDGADDS)
	_register("syscall.SIOCBRDGARL", syscall.SIOCBRDGARL)
	_register("syscall.SIOCBRDGDADDR", syscall.SIOCBRDGDADDR)
	_register("syscall.SIOCBRDGDEL", syscall.SIOCBRDGDEL)
	_register("syscall.SIOCBRDGDELS", syscall.SIOCBRDGDELS)
	_register("syscall.SIOCBRDGFLUSH", syscall.SIOCBRDGFLUSH)
	_register("syscall.SIOCBRDGFRL", syscall.SIOCBRDGFRL)
	_register("syscall.SIOCBRDGGCACHE", syscall.SIOCBRDGGCACHE)
	_register("syscall.SIOCBRDGGFD", syscall.SIOCBRDGGFD)
	_register("syscall.SIOCBRDGGHT", syscall.SIOCBRDGGHT)
	_register("syscall.SIOCBRDGGIFFLGS", syscall.SIOCBRDGGIFFLGS)
	_register("syscall.SIOCBRDGGMA", syscall.SIOCBRDGGMA)
	_register("syscall.SIOCBRDGGPARAM", syscall.SIOCBRDGGPARAM)
	_register("syscall.SIOCBRDGGPRI", syscall.SIOCBRDGGPRI)
	_register("syscall.SIOCBRDGGRL", syscall.SIOCBRDGGRL)
	_register("syscall.SIOCBRDGGTO", syscall.SIOCBRDGGTO)
	_register("syscall.SIOCBRDGIFS", syscall.SIOCBRDGIFS)
	_register("syscall.SIOCBRDGRTS", syscall.SIOCBRDGRTS)
	_register("syscall.SIOCBRDGSADDR", syscall.SIOCBRDGSADDR)
	_register("syscall.SIOCBRDGSCACHE", syscall.SIOCBRDGSCACHE)
	_register("syscall.SIOCBRDGSFD", syscall.SIOCBRDGSFD)
	_register("syscall.SIOCBRDGSHT", syscall.SIOCBRDGSHT)
	_register("syscall.SIOCBRDGSIFCOST", syscall.SIOCBRDGSIFCOST)
	_register("syscall.SIOCBRDGSIFFLGS", syscall.SIOCBRDGSIFFLGS)
	_register("syscall.SIOCBRDGSIFPRIO", syscall.SIOCBRDGSIFPRIO)
	_register("syscall.SIOCBRDGSIFPROT", syscall.SIOCBRDGSIFPROT)
	_register("syscall.SIOCBRDGSMA", syscall.SIOCBRDGSMA)
	_register("syscall.SIOCBRDGSPRI", syscall.SIOCBRDGSPRI)
	_register("syscall.SIOCBRDGSPROTO", syscall.SIOCBRDGSPROTO)
	_register("syscall.SIOCBRDGSTO", syscall.SIOCBRDGSTO)
	_register("syscall.SIOCBRDGSTXHC", syscall.SIOCBRDGSTXHC)
	_register("syscall.SIOCDELLABEL", syscall.SIOCDELLABEL)
	...
	_register("syscall.SIOCDIFPARENT", syscall.SIOCDIFPARENT)
	_register("syscall.SIOCDIFPHYADDR", syscall.SIOCDIFPHYADDR)
	_register("syscall.SIOCDPWE3NEIGHBOR", syscall.SIOCDPWE3NEIGHBOR)
	_register("syscall.SIOCDVNETID", syscall.SIOCDVNETID)
	_register("syscall.SIOCGETKALIVE", syscall.SIOCGETKALIVE)
	_register("syscall.SIOCGETLABEL", syscall.SIOCGETLABEL)
	_register("syscall.SIOCGETMPWCFG", syscall.SIOCGETMPWCFG)
	_register("syscall.SIOCGETPFLOW", syscall.SIOCGETPFLOW)
	...
	_register("syscall.SIOCGIFGATTR", syscall.SIOCGIFGATTR)
	_register("syscall.SIOCGIFGENERIC", syscall.SIOCGIFGENERIC)
	_register("syscall.SIOCGIFGLIST", syscall.SIOCGIFGLIST)
	_register("syscall.SIOCGIFGMEMB", syscall.SIOCGIFGMEMB)
	_register("syscall.SIOCGIFGROUP", syscall.SIOCGIFGROUP)
	_register("syscall.SIOCGIFHARDMTU", syscall.SIOCGIFHARDMTU)
	_register("syscall.SIOCGIFLLPRIO", syscall.SIOCGIFLLPRIO)
	...
	_register("syscall.SIOCGIFPAIR", syscall.SIOCGIFPAIR)
	_register("syscall.SIOCGIFPARENT", syscall.SIOCGIFPARENT)
	_register("syscall.SIOCGIFPRIORITY", syscall.SIOCGIFPRIORITY)
	_register("syscall.SIOCGIFRDOMAIN", syscall.SIOCGIFRDOMAIN)
	_register("syscall.SIOCGIFRTLABEL", syscall.SIOCGIFRTLABEL)
	_register("syscall.SIOCGIFRXR", syscall.SIOCGIFRXR)
	_register("syscall.SIOCGIFSFFPAGE", syscall.SIOCGIFSFFPAGE)
	_register("syscall.SIOCGIFXFLAGS", syscall.SIOCGIFXFLAGS)
	_register("syscall.SIOCGLIFPHYADDR", syscall.SIOCGLIFPHYADDR)
	_register("syscall.SIOCGLIFPHYDF", syscall.SIOCGLIFPHYDF)
	_register("syscall.SIOCGLIFPHYECN", syscall.SIOCGLIFPHYECN)
	_register("syscall.SIOCGLIFPHYRTABLE", syscall.SIOCGLIFPHYRTABLE)
	_register("syscall.SIOCGLIFPHYTTL", syscall.SIOCGLIFPHYTTL)
	_register("syscall.SIOCGPGRP", syscall.SIOCGPGRP)
	_register("syscall.SIOCGPWE3", syscall.SIOCGPWE3)
	_register("syscall.SIOCGPWE3CTRLWORD", syscall.SIOCGPWE3CTRLWORD)
	_register("syscall.SIOCGPWE3FAT", syscall.SIOCGPWE3FAT)
	_register("syscall.SIOCGPWE3NEIGHBOR", syscall.SIOCGPWE3NEIGHBOR)
	_register("syscall.SIOCGSPPPPARAMS", syscall.SIOCGSPPPPARAMS)
	_register("syscall.SIOCGTXHPRIO", syscall.SIOCGTXHPRIO)
	_register("syscall.SIOCGUMBINFO", syscall.SIOCGUMBINFO)
	_register("syscall.SIOCGUMBPARAM", syscall.SIOCGUMBPARAM)
	_register("syscall.SIOCGVH", syscall.SIOCGVH)
	_register("syscall.SIOCGVNETFLOWID", syscall.SIOCGVNETFLOWID)
	_register("syscall.SIOCGVNETID", syscall.SIOCGVNETID)
	_register("syscall.SIOCIFAFATTACH", syscall.SIOCIFAFATTACH)
	_register("syscall.SIOCIFAFDETACH", syscall.SIOCIFAFDETACH)
	...
	_register("syscall.SIOCSETKALIVE", syscall.SIOCSETKALIVE)
	_register("syscall.SIOCSETLABEL", syscall.SIOCSETLABEL)
	_register("syscall.SIOCSETMPWCFG", syscall.SIOCSETMPWCFG)
	_register("syscall.SIOCSETPFLOW", syscall.SIOCSETPFLOW)
	...
	_register("syscall.SIOCSIFPAIR", syscall.SIOCSIFPAIR)
	_register("syscall.SIOCSIFPARENT", syscall.SIOCSIFPARENT)
	_register("syscall.SIOCSIFPRIORITY", syscall.SIOCSIFPRIORITY)
	_register("syscall.SIOCSIFRDOMAIN", syscall.SIOCSIFRDOMAIN)
	_register("syscall.SIOCSIFRTLABEL", syscall.SIOCSIFRTLABEL)
	_register("syscall.SIOCSIFXFLAGS", syscall.SIOCSIFXFLAGS)
	_register("syscall.SIOCSLIFPHYADDR", syscall.SIOCSLIFPHYADDR)
	_register("syscall.SIOCSLIFPHYDF", syscall.SIOCSLIFPHYDF)
	_register("syscall.SIOCSLIFPHYECN", syscall.SIOCSLIFPHYECN)
	_register("syscall.SIOCSLIFPHYRTABLE", syscall.SIOCSLIFPHYRTABLE)
	_register("syscall.SIOCSLIFPHYTTL", syscall.SIOCSLIFPHYTTL)
	_register("syscall.SIOCSPGRP", syscall.SIOCSPGRP)
	_register("syscall.SIOCSPWE3CTRLWORD", syscall.SIOCSPWE3CTRLWORD)
	_register("syscall.SIOCSPWE3FAT", syscall.SIOCSPWE3FAT)
	_register("syscall.SIOCSPWE3NEIGHBOR", syscall.SIOCSPWE3NEIGHBOR)
	_register("syscall.SIOCSSPPPPARAMS", syscall.SIOCSSPPPPARAMS)
	_register("syscall.SIOCSTXHPRIO", syscall.SIOCSTXHPRIO)
	_register("syscall.SIOCSUMBPARAM", syscall.SIOCSUMBPARAM)
	_register("syscall.SIOCSVH", syscall.SIOCSVH)
	_register("syscall.SIOCSVNETFLOWID", syscall.SIOCSVNETFLOWID)
	_register("syscall.SIOCSVNETID", syscall.SIOCSVNETID)
	_register("syscall.SIOCSWGDPID", syscall.SIOCSWGDPID)
	_register("syscall.SIOCSWGMAXFLOW", syscall.SIOCSWGMAXFLOW)
	_register("syscall.SIOCSWGMAXGROUP", syscall.SIOCSWGMAXGROUP)
	_register("syscall.SIOCSWSDPID", syscall.SIOCSWSDPID)
	_register("syscall.SIOCSWSPORTNO", syscall.SIOCSWSPORTNO)
	_register("syscall.SOCK_CLOEXEC", syscall.SOCK_CLOEXEC)
	_register("syscall.SOCK_DGRAM", syscall.SOCK_DGRAM)
	_register("syscall.SOCK_DNS", syscall.SOCK_DNS)
	...
	_register("syscall.SO_BINDANY", syscall.SO_BINDANY)
	...
	_register("syscall.SO_NETPROC", syscall.SO_NETPROC)
	...
	_register("syscall.SO_RTABLE", syscall.SO_RTABLE)
	...
	_register("syscall.SO_SPLICE", syscall.SO_SPLICE)
	...
	_register("syscall.SO_ZEROIZE", syscall.SO_ZEROIZE)
	...
	_register("syscall.SYS_ADJFREQ", syscall.SYS_ADJFREQ)
	...
	_register("syscall.SYS_GETDTABLECOUNT", syscall.SYS_GETDTABLECOUNT)
	_register("syscall.SYS_GETEGID", syscall.SYS_GETEGID)
	_register("syscall.SYS_GETENTROPY", syscall.SYS_GETENTROPY)
	...
	_register("syscall.SYS_GETLOGIN_R", syscall.SYS_GETLOGIN_R)
	...
	_register("syscall.SYS_GETRTABLE", syscall.SYS_GETRTABLE)
	...
	_register("syscall.SYS_GETTHRID", syscall.SYS_GETTHRID)
	...
	_register("syscall.SYS_KBIND", syscall.SYS_KBIND)
	...
	_register("syscall.SYS_MQUERY", syscall.SYS_MQUERY)
	...
	_register("syscall.SYS_PLEDGE", syscall.SYS_PLEDGE)
	...
	_register("syscall.SYS_SENDSYSLOG", syscall.SYS_SENDSYSLOG)
	...
	_register("syscall.SYS_SETRTABLE", syscall.SYS_SETRTABLE)
	...
	_register("syscall.SYS_SYSCTL", syscall.SYS_SYSCTL)
	_register("syscall.SYS_THRKILL", syscall.SYS_THRKILL)
	...
	_register("syscall.SYS_UNVEIL", syscall.SYS_UNVEIL)
	...
	_register("syscall.SYS___GET_TCB", syscall.SYS___GET_TCB)
	_register("syscall.SYS___SEMCTL", syscall.SYS___SEMCTL)
	_register("syscall.SYS___SET_TCB", syscall.SYS___SET_TCB)
	_register("syscall.SYS___SYSCTL", syscall.SYS___SYSCTL)
	_register("syscall.SYS___TFORK", syscall.SYS___TFORK)
	_register("syscall.SYS___THREXIT", syscall.SYS___THREXIT)
	_register("syscall.SYS___THRSIGDIVERT", syscall.SYS___THRSIGDIVERT)
	_register("syscall.SYS___THRSLEEP", syscall.SYS___THRSLEEP)
	_register("syscall.SYS___THRWAKEUP", syscall.SYS___THRWAKEUP)
	...
	_register("syscall.TCP_SACK_ENABLE", syscall.TCP_SACK_ENABLE)
	...
	_register("syscall.TIOCCHKVERAUTH", syscall.TIOCCHKVERAUTH)
	_register("syscall.TIOCCLRVERAUTH", syscall.TIOCCLRVERAUTH)
	...
	_register("syscall.TIOCFLAG_PPS", syscall.TIOCFLAG_PPS)
	...
	_register("syscall.TIOCGTSTAMP", syscall.TIOCGTSTAMP)
	...
	_register("syscall.TIOCSETVERAUTH", syscall.TIOCSETVERAUTH)
	...
	_register("syscall.TIOCSTSTAMP", syscall.TIOCSTSTAMP)
	_register("syscall.TIOCSWINSZ", syscall.TIOCSWINSZ)
	_register("syscall.TIOCUCNTL", syscall.TIOCUCNTL)
	_register("syscall.TIOCUCNTL_CBRK", syscall.TIOCUCNTL_CBRK)
	_register("syscall.TIOCUCNTL_SBRK", syscall.TIOCUCNTL_SBRK)
