...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("syscall.AF_OROUTE", syscall.AF_OROUTE)
	...
	_register("syscall.BIOCFEEDBACK", syscall.BIOCFEEDBACK)
	...
	_register("syscall.BIOCGFEEDBACK", syscall.BIOCGFEEDBACK)
	...
	_register("syscall.BIOCGSTATSOLD", syscall.BIOCGSTATSOLD)
	...
	_register("syscall.BIOCSFEEDBACK", syscall.BIOCSFEEDBACK)
	...
	_register("syscall.BIOCSTCPF", syscall.BIOCSTCPF)
	_register("syscall.BIOCSUDPF", syscall.BIOCSUDPF)
	...
	_register("syscall.BpfTimeval", reflect.TypeOf((*syscall.BpfTimeval)(nil)).Elem())
	_register("syscall.*BpfTimeval", reflect.TypeOf((*syscall.BpfTimeval)(nil)))
	...
	_register("syscall.CLONE_CSIGNAL", syscall.CLONE_CSIGNAL)
	_register("syscall.CLONE_FILES", syscall.CLONE_FILES)
	_register("syscall.CLONE_FS", syscall.CLONE_FS)
	_register("syscall.CLONE_PID", syscall.CLONE_PID)
	...
	_register("syscall.CTL_QUERY", syscall.CTL_QUERY)
	...
	_register("syscall.DIOCBSFLUSH", syscall.DIOCBSFLUSH)
	...
	_register("syscall.DLT_HDLC", syscall.DLT_HDLC)
	_register("syscall.DLT_HHDLC", syscall.DLT_HHDLC)
	_register("syscall.DLT_HIPPI", syscall.DLT_HIPPI)
	...
	_register("syscall.DLT_RAWAF_MASK", syscall.DLT_RAWAF_MASK)
	...
	_register("syscall.EMUL_LINUX", syscall.EMUL_LINUX)
	_register("syscall.EMUL_LINUX32", syscall.EMUL_LINUX32)
	_register("syscall.EMUL_MAXID", syscall.EMUL_MAXID)
	...
	_register("syscall.ETHERCAP_JUMBO_MTU", syscall.ETHERCAP_JUMBO_MTU)
	_register("syscall.ETHERCAP_VLAN_HWTAGGING", syscall.ETHERCAP_VLAN_HWTAGGING)
	_register("syscall.ETHERCAP_VLAN_MTU", syscall.ETHERCAP_VLAN_MTU)
	_register("syscall.ETHERMIN", syscall.ETHERMIN)
	_register("syscall.ETHERMTU", syscall.ETHERMTU)
	_register("syscall.ETHERMTU_JUMBO", syscall.ETHERMTU_JUMBO)
	_register("syscall.ETHERTYPE_8023", syscall.ETHERTYPE_8023)
	_register("syscall.ETHERTYPE_AARP", syscall.ETHERTYPE_AARP)
	_register("syscall.ETHERTYPE_ACCTON", syscall.ETHERTYPE_ACCTON)
	_register("syscall.ETHERTYPE_AEONIC", syscall.ETHERTYPE_AEONIC)
	_register("syscall.ETHERTYPE_ALPHA", syscall.ETHERTYPE_ALPHA)
	_register("syscall.ETHERTYPE_AMBER", syscall.ETHERTYPE_AMBER)
	_register("syscall.ETHERTYPE_AMOEBA", syscall.ETHERTYPE_AMOEBA)
	_register("syscall.ETHERTYPE_APOLLO", syscall.ETHERTYPE_APOLLO)
	_register("syscall.ETHERTYPE_APOLLODOMAIN", syscall.ETHERTYPE_APOLLODOMAIN)
	_register("syscall.ETHERTYPE_APPLETALK", syscall.ETHERTYPE_APPLETALK)
	_register("syscall.ETHERTYPE_APPLITEK", syscall.ETHERTYPE_APPLITEK)
	_register("syscall.ETHERTYPE_ARGONAUT", syscall.ETHERTYPE_ARGONAUT)
	_register("syscall.ETHERTYPE_ARP", syscall.ETHERTYPE_ARP)
	_register("syscall.ETHERTYPE_AT", syscall.ETHERTYPE_AT)
	_register("syscall.ETHERTYPE_ATALK", syscall.ETHERTYPE_ATALK)
	_register("syscall.ETHERTYPE_ATOMIC", syscall.ETHERTYPE_ATOMIC)
	_register("syscall.ETHERTYPE_ATT", syscall.ETHERTYPE_ATT)
	_register("syscall.ETHERTYPE_ATTSTANFORD", syscall.ETHERTYPE_ATTSTANFORD)
	_register("syscall.ETHERTYPE_AUTOPHON", syscall.ETHERTYPE_AUTOPHON)
	_register("syscall.ETHERTYPE_AXIS", syscall.ETHERTYPE_AXIS)
	_register("syscall.ETHERTYPE_BCLOOP", syscall.ETHERTYPE_BCLOOP)
	_register("syscall.ETHERTYPE_BOFL", syscall.ETHERTYPE_BOFL)
	_register("syscall.ETHERTYPE_CABLETRON", syscall.ETHERTYPE_CABLETRON)
	_register("syscall.ETHERTYPE_CHAOS", syscall.ETHERTYPE_CHAOS)
	_register("syscall.ETHERTYPE_COMDESIGN", syscall.ETHERTYPE_COMDESIGN)
	_register("syscall.ETHERTYPE_COMPUGRAPHIC", syscall.ETHERTYPE_COMPUGRAPHIC)
	_register("syscall.ETHERTYPE_COUNTERPOINT", syscall.ETHERTYPE_COUNTERPOINT)
	_register("syscall.ETHERTYPE_CRONUS", syscall.ETHERTYPE_CRONUS)
	_register("syscall.ETHERTYPE_CRONUSVLN", syscall.ETHERTYPE_CRONUSVLN)
	_register("syscall.ETHERTYPE_DCA", syscall.ETHERTYPE_DCA)
	_register("syscall.ETHERTYPE_DDE", syscall.ETHERTYPE_DDE)
	_register("syscall.ETHERTYPE_DEBNI", syscall.ETHERTYPE_DEBNI)
	_register("syscall.ETHERTYPE_DECAM", syscall.ETHERTYPE_DECAM)
	_register("syscall.ETHERTYPE_DECCUST", syscall.ETHERTYPE_DECCUST)
	_register("syscall.ETHERTYPE_DECDIAG", syscall.ETHERTYPE_DECDIAG)
	_register("syscall.ETHERTYPE_DECDNS", syscall.ETHERTYPE_DECDNS)
	_register("syscall.ETHERTYPE_DECDTS", syscall.ETHERTYPE_DECDTS)
	_register("syscall.ETHERTYPE_DECEXPER", syscall.ETHERTYPE_DECEXPER)
	_register("syscall.ETHERTYPE_DECLAST", syscall.ETHERTYPE_DECLAST)
	_register("syscall.ETHERTYPE_DECLTM", syscall.ETHERTYPE_DECLTM)
	_register("syscall.ETHERTYPE_DECMUMPS", syscall.ETHERTYPE_DECMUMPS)
	_register("syscall.ETHERTYPE_DECNETBIOS", syscall.ETHERTYPE_DECNETBIOS)
	_register("syscall.ETHERTYPE_DELTACON", syscall.ETHERTYPE_DELTACON)
	_register("syscall.ETHERTYPE_DIDDLE", syscall.ETHERTYPE_DIDDLE)
	_register("syscall.ETHERTYPE_DLOG1", syscall.ETHERTYPE_DLOG1)
	_register("syscall.ETHERTYPE_DLOG2", syscall.ETHERTYPE_DLOG2)
	_register("syscall.ETHERTYPE_DN", syscall.ETHERTYPE_DN)
	_register("syscall.ETHERTYPE_DOGFIGHT", syscall.ETHERTYPE_DOGFIGHT)
	_register("syscall.ETHERTYPE_DSMD", syscall.ETHERTYPE_DSMD)
	_register("syscall.ETHERTYPE_ECMA", syscall.ETHERTYPE_ECMA)
	_register("syscall.ETHERTYPE_ENCRYPT", syscall.ETHERTYPE_ENCRYPT)
	_register("syscall.ETHERTYPE_ES", syscall.ETHERTYPE_ES)
	_register("syscall.ETHERTYPE_EXCELAN", syscall.ETHERTYPE_EXCELAN)
	_register("syscall.ETHERTYPE_EXPERDATA", syscall.ETHERTYPE_EXPERDATA)
	_register("syscall.ETHERTYPE_FLIP", syscall.ETHERTYPE_FLIP)
	_register("syscall.ETHERTYPE_FLOWCONTROL", syscall.ETHERTYPE_FLOWCONTROL)
	_register("syscall.ETHERTYPE_FRARP", syscall.ETHERTYPE_FRARP)
	_register("syscall.ETHERTYPE_GENDYN", syscall.ETHERTYPE_GENDYN)
	_register("syscall.ETHERTYPE_HAYES", syscall.ETHERTYPE_HAYES)
	_register("syscall.ETHERTYPE_HIPPI_FP", syscall.ETHERTYPE_HIPPI_FP)
	_register("syscall.ETHERTYPE_HITACHI", syscall.ETHERTYPE_HITACHI)
	_register("syscall.ETHERTYPE_HP", syscall.ETHERTYPE_HP)
	_register("syscall.ETHERTYPE_IEEEPUP", syscall.ETHERTYPE_IEEEPUP)
	_register("syscall.ETHERTYPE_IEEEPUPAT", syscall.ETHERTYPE_IEEEPUPAT)
	_register("syscall.ETHERTYPE_IMLBL", syscall.ETHERTYPE_IMLBL)
	_register("syscall.ETHERTYPE_IMLBLDIAG", syscall.ETHERTYPE_IMLBLDIAG)
	_register("syscall.ETHERTYPE_IP", syscall.ETHERTYPE_IP)
	_register("syscall.ETHERTYPE_IPAS", syscall.ETHERTYPE_IPAS)
	_register("syscall.ETHERTYPE_IPV6", syscall.ETHERTYPE_IPV6)
	_register("syscall.ETHERTYPE_IPX", syscall.ETHERTYPE_IPX)
	_register("syscall.ETHERTYPE_IPXNEW", syscall.ETHERTYPE_IPXNEW)
	_register("syscall.ETHERTYPE_KALPANA", syscall.ETHERTYPE_KALPANA)
	_register("syscall.ETHERTYPE_LANBRIDGE", syscall.ETHERTYPE_LANBRIDGE)
	_register("syscall.ETHERTYPE_LANPROBE", syscall.ETHERTYPE_LANPROBE)
	_register("syscall.ETHERTYPE_LAT", syscall.ETHERTYPE_LAT)
	_register("syscall.ETHERTYPE_LBACK", syscall.ETHERTYPE_LBACK)
	_register("syscall.ETHERTYPE_LITTLE", syscall.ETHERTYPE_LITTLE)
	_register("syscall.ETHERTYPE_LOGICRAFT", syscall.ETHERTYPE_LOGICRAFT)
	_register("syscall.ETHERTYPE_LOOPBACK", syscall.ETHERTYPE_LOOPBACK)
	_register("syscall.ETHERTYPE_MATRA", syscall.ETHERTYPE_MATRA)
	_register("syscall.ETHERTYPE_MAX", syscall.ETHERTYPE_MAX)
	_register("syscall.ETHERTYPE_MERIT", syscall.ETHERTYPE_MERIT)
	_register("syscall.ETHERTYPE_MICP", syscall.ETHERTYPE_MICP)
	_register("syscall.ETHERTYPE_MOPDL", syscall.ETHERTYPE_MOPDL)
	_register("syscall.ETHERTYPE_MOPRC", syscall.ETHERTYPE_MOPRC)
	_register("syscall.ETHERTYPE_MOTOROLA", syscall.ETHERTYPE_MOTOROLA)
	_register("syscall.ETHERTYPE_MPLS", syscall.ETHERTYPE_MPLS)
	_register("syscall.ETHERTYPE_MPLS_MCAST", syscall.ETHERTYPE_MPLS_MCAST)
	_register("syscall.ETHERTYPE_MUMPS", syscall.ETHERTYPE_MUMPS)
	_register("syscall.ETHERTYPE_NBPCC", syscall.ETHERTYPE_NBPCC)
	_register("syscall.ETHERTYPE_NBPCLAIM", syscall.ETHERTYPE_NBPCLAIM)
	_register("syscall.ETHERTYPE_NBPCLREQ", syscall.ETHERTYPE_NBPCLREQ)
	_register("syscall.ETHERTYPE_NBPCLRSP", syscall.ETHERTYPE_NBPCLRSP)
	_register("syscall.ETHERTYPE_NBPCREQ", syscall.ETHERTYPE_NBPCREQ)
	_register("syscall.ETHERTYPE_NBPCRSP", syscall.ETHERTYPE_NBPCRSP)
	_register("syscall.ETHERTYPE_NBPDG", syscall.ETHERTYPE_NBPDG)
	_register("syscall.ETHERTYPE_NBPDGB", syscall.ETHERTYPE_NBPDGB)
	_register("syscall.ETHERTYPE_NBPDLTE", syscall.ETHERTYPE_NBPDLTE)
	_register("syscall.ETHERTYPE_NBPRAR", syscall.ETHERTYPE_NBPRAR)
	_register("syscall.ETHERTYPE_NBPRAS", syscall.ETHERTYPE_NBPRAS)
	_register("syscall.ETHERTYPE_NBPRST", syscall.ETHERTYPE_NBPRST)
	_register("syscall.ETHERTYPE_NBPSCD", syscall.ETHERTYPE_NBPSCD)
	_register("syscall.ETHERTYPE_NBPVCD", syscall.ETHERTYPE_NBPVCD)
	_register("syscall.ETHERTYPE_NBS", syscall.ETHERTYPE_NBS)
	_register("syscall.ETHERTYPE_NCD", syscall.ETHERTYPE_NCD)
	_register("syscall.ETHERTYPE_NESTAR", syscall.ETHERTYPE_NESTAR)
	_register("syscall.ETHERTYPE_NETBEUI", syscall.ETHERTYPE_NETBEUI)
	_register("syscall.ETHERTYPE_NOVELL", syscall.ETHERTYPE_NOVELL)
	_register("syscall.ETHERTYPE_NS", syscall.ETHERTYPE_NS)
	_register("syscall.ETHERTYPE_NSAT", syscall.ETHERTYPE_NSAT)
	_register("syscall.ETHERTYPE_NSCOMPAT", syscall.ETHERTYPE_NSCOMPAT)
	_register("syscall.ETHERTYPE_NTRAILER", syscall.ETHERTYPE_NTRAILER)
	_register("syscall.ETHERTYPE_OS9", syscall.ETHERTYPE_OS9)
	_register("syscall.ETHERTYPE_OS9NET", syscall.ETHERTYPE_OS9NET)
	_register("syscall.ETHERTYPE_PACER", syscall.ETHERTYPE_PACER)
	_register("syscall.ETHERTYPE_PAE", syscall.ETHERTYPE_PAE)
	_register("syscall.ETHERTYPE_PCS", syscall.ETHERTYPE_PCS)
	_register("syscall.ETHERTYPE_PLANNING", syscall.ETHERTYPE_PLANNING)
	_register("syscall.ETHERTYPE_PPP", syscall.ETHERTYPE_PPP)
	_register("syscall.ETHERTYPE_PPPOE", syscall.ETHERTYPE_PPPOE)
	_register("syscall.ETHERTYPE_PPPOEDISC", syscall.ETHERTYPE_PPPOEDISC)
	_register("syscall.ETHERTYPE_PRIMENTS", syscall.ETHERTYPE_PRIMENTS)
	_register("syscall.ETHERTYPE_PUP", syscall.ETHERTYPE_PUP)
	_register("syscall.ETHERTYPE_PUPAT", syscall.ETHERTYPE_PUPAT)
	_register("syscall.ETHERTYPE_RACAL", syscall.ETHERTYPE_RACAL)
	_register("syscall.ETHERTYPE_RATIONAL", syscall.ETHERTYPE_RATIONAL)
	_register("syscall.ETHERTYPE_RAWFR", syscall.ETHERTYPE_RAWFR)
	_register("syscall.ETHERTYPE_RCL", syscall.ETHERTYPE_RCL)
	_register("syscall.ETHERTYPE_RDP", syscall.ETHERTYPE_RDP)
	_register("syscall.ETHERTYPE_RETIX", syscall.ETHERTYPE_RETIX)
	_register("syscall.ETHERTYPE_REVARP", syscall.ETHERTYPE_REVARP)
	_register("syscall.ETHERTYPE_SCA", syscall.ETHERTYPE_SCA)
	_register("syscall.ETHERTYPE_SECTRA", syscall.ETHERTYPE_SECTRA)
	_register("syscall.ETHERTYPE_SECUREDATA", syscall.ETHERTYPE_SECUREDATA)
	_register("syscall.ETHERTYPE_SGITW", syscall.ETHERTYPE_SGITW)
	_register("syscall.ETHERTYPE_SG_BOUNCE", syscall.ETHERTYPE_SG_BOUNCE)
	_register("syscall.ETHERTYPE_SG_DIAG", syscall.ETHERTYPE_SG_DIAG)
	_register("syscall.ETHERTYPE_SG_NETGAMES", syscall.ETHERTYPE_SG_NETGAMES)
	_register("syscall.ETHERTYPE_SG_RESV", syscall.ETHERTYPE_SG_RESV)
	_register("syscall.ETHERTYPE_SIMNET", syscall.ETHERTYPE_SIMNET)
	_register("syscall.ETHERTYPE_SLOWPROTOCOLS", syscall.ETHERTYPE_SLOWPROTOCOLS)
	_register("syscall.ETHERTYPE_SNA", syscall.ETHERTYPE_SNA)
	_register("syscall.ETHERTYPE_SNMP", syscall.ETHERTYPE_SNMP)
	_register("syscall.ETHERTYPE_SONIX", syscall.ETHERTYPE_SONIX)
	_register("syscall.ETHERTYPE_SPIDER", syscall.ETHERTYPE_SPIDER)
	_register("syscall.ETHERTYPE_SPRITE", syscall.ETHERTYPE_SPRITE)
	_register("syscall.ETHERTYPE_STP", syscall.ETHERTYPE_STP)
	_register("syscall.ETHERTYPE_TALARIS", syscall.ETHERTYPE_TALARIS)
	_register("syscall.ETHERTYPE_TALARISMC", syscall.ETHERTYPE_TALARISMC)
	_register("syscall.ETHERTYPE_TCPCOMP", syscall.ETHERTYPE_TCPCOMP)
	_register("syscall.ETHERTYPE_TCPSM", syscall.ETHERTYPE_TCPSM)
	_register("syscall.ETHERTYPE_TEC", syscall.ETHERTYPE_TEC)
	_register("syscall.ETHERTYPE_TIGAN", syscall.ETHERTYPE_TIGAN)
	_register("syscall.ETHERTYPE_TRAIL", syscall.ETHERTYPE_TRAIL)
	_register("syscall.ETHERTYPE_TRANSETHER", syscall.ETHERTYPE_TRANSETHER)
	_register("syscall.ETHERTYPE_TYMSHARE", syscall.ETHERTYPE_TYMSHARE)
	_register("syscall.ETHERTYPE_UBBST", syscall.ETHERTYPE_UBBST)
	_register("syscall.ETHERTYPE_UBDEBUG", syscall.ETHERTYPE_UBDEBUG)
	_register("syscall.ETHERTYPE_UBDIAGLOOP", syscall.ETHERTYPE_UBDIAGLOOP)
	_register("syscall.ETHERTYPE_UBDL", syscall.ETHERTYPE_UBDL)
	_register("syscall.ETHERTYPE_UBNIU", syscall.ETHERTYPE_UBNIU)
	_register("syscall.ETHERTYPE_UBNMC", syscall.ETHERTYPE_UBNMC)
	_register("syscall.ETHERTYPE_VALID", syscall.ETHERTYPE_VALID)
	_register("syscall.ETHERTYPE_VARIAN", syscall.ETHERTYPE_VARIAN)
	_register("syscall.ETHERTYPE_VAXELN", syscall.ETHERTYPE_VAXELN)
	_register("syscall.ETHERTYPE_VEECO", syscall.ETHERTYPE_VEECO)
	_register("syscall.ETHERTYPE_VEXP", syscall.ETHERTYPE_VEXP)
	_register("syscall.ETHERTYPE_VGLAB", syscall.ETHERTYPE_VGLAB)
	_register("syscall.ETHERTYPE_VINES", syscall.ETHERTYPE_VINES)
	_register("syscall.ETHERTYPE_VINESECHO", syscall.ETHERTYPE_VINESECHO)
	_register("syscall.ETHERTYPE_VINESLOOP", syscall.ETHERTYPE_VINESLOOP)
	_register("syscall.ETHERTYPE_VITAL", syscall.ETHERTYPE_VITAL)
	_register("syscall.ETHERTYPE_VLAN", syscall.ETHERTYPE_VLAN)
	_register("syscall.ETHERTYPE_VLTLMAN", syscall.ETHERTYPE_VLTLMAN)
	_register("syscall.ETHERTYPE_VPROD", syscall.ETHERTYPE_VPROD)
	_register("syscall.ETHERTYPE_VURESERVED", syscall.ETHERTYPE_VURESERVED)
	_register("syscall.ETHERTYPE_WATERLOO", syscall.ETHERTYPE_WATERLOO)
	_register("syscall.ETHERTYPE_WELLFLEET", syscall.ETHERTYPE_WELLFLEET)
	_register("syscall.ETHERTYPE_X25", syscall.ETHERTYPE_X25)
	_register("syscall.ETHERTYPE_X75", syscall.ETHERTYPE_X75)
	_register("syscall.ETHERTYPE_XNSSM", syscall.ETHERTYPE_XNSSM)
	_register("syscall.ETHERTYPE_XTP", syscall.ETHERTYPE_XTP)
	_register("syscall.ETHER_ADDR_LEN", syscall.ETHER_ADDR_LEN)
	_register("syscall.ETHER_CRC_LEN", syscall.ETHER_CRC_LEN)
	_register("syscall.ETHER_CRC_POLY_BE", syscall.ETHER_CRC_POLY_BE)
	_register("syscall.ETHER_CRC_POLY_LE", syscall.ETHER_CRC_POLY_LE)
	_register("syscall.ETHER_HDR_LEN", syscall.ETHER_HDR_LEN)
	_register("syscall.ETHER_MAX_LEN", syscall.ETHER_MAX_LEN)
	_register("syscall.ETHER_MAX_LEN_JUMBO", syscall.ETHER_MAX_LEN_JUMBO)
	_register("syscall.ETHER_MIN_LEN", syscall.ETHER_MIN_LEN)
	_register("syscall.ETHER_PPPOE_ENCAP_LEN", syscall.ETHER_PPPOE_ENCAP_LEN)
	_register("syscall.ETHER_TYPE_LEN", syscall.ETHER_TYPE_LEN)
	_register("syscall.ETHER_VLAN_ENCAP_LEN", syscall.ETHER_VLAN_ENCAP_LEN)
	...
	_register("syscall.F_CLOSEM", syscall.F_CLOSEM)
	_register("syscall.F_DUPFD", syscall.F_DUPFD)
	_register("syscall.F_DUPFD_CLOEXEC", syscall.F_DUPFD_CLOEXEC)
	_register("syscall.F_FSCTL", syscall.F_FSCTL)
	_register("syscall.F_FSDIRMASK", syscall.F_FSDIRMASK)
	_register("syscall.F_FSIN", syscall.F_FSIN)
	_register("syscall.F_FSINOUT", syscall.F_FSINOUT)
	_register("syscall.F_FSOUT", syscall.F_FSOUT)
	_register("syscall.F_FSPRIV", syscall.F_FSPRIV)
	_register("syscall.F_FSVOID", syscall.F_FSVOID)
	...
	_register("syscall.F_MAXFD", syscall.F_MAXFD)
	_register("syscall.F_OK", syscall.F_OK)
	_register("syscall.F_PARAM_MASK", syscall.F_PARAM_MASK)
	_register("syscall.F_PARAM_MAX", syscall.F_PARAM_MAX)
	...
	_register("syscall.IFA_ROUTE", syscall.IFA_ROUTE)
	...
	_register("syscall.IFT_DOCSCABLEUPSTREAMCHANNEL", syscall.IFT_DOCSCABLEUPSTREAMCHANNEL)
	...
	_register("syscall.IFT_ECONET", syscall.IFT_ECONET)
	...
	_register("syscall.IFT_LINEGROUP", syscall.IFT_LINEGROUP)
	...
	_register("syscall.IFT_PON155", syscall.IFT_PON155)
	_register("syscall.IFT_PON622", syscall.IFT_PON622)
	...
	_register("syscall.IFT_PROPATM", syscall.IFT_PROPATM)
	...
	_register("syscall.IFT_Q2931", syscall.IFT_Q2931)
	...
	_register("syscall.IFT_SIPSIG", syscall.IFT_SIPSIG)
	_register("syscall.IFT_SIPTG", syscall.IFT_SIPTG)
	...
	_register("syscall.IFT_TELINK", syscall.IFT_TELINK)
	...
	_register("syscall.IFT_VIRTUALTG", syscall.IFT_VIRTUALTG)
	_register("syscall.IFT_VOICEDID", syscall.IFT_VOICEDID)
	_register("syscall.IFT_VOICEEM", syscall.IFT_VOICEEM)
	_register("syscall.IFT_VOICEEMFGD", syscall.IFT_VOICEEMFGD)
	_register("syscall.IFT_VOICEENCAP", syscall.IFT_VOICEENCAP)
	_register("syscall.IFT_VOICEFGDEANA", syscall.IFT_VOICEFGDEANA)
	...
	_register("syscall.IFT_VOICEOVERCABLE", syscall.IFT_VOICEOVERCABLE)
	...
	_register("syscall.IPPROTO_IPV6_ICMP", syscall.IPPROTO_IPV6_ICMP)
	...
	_register("syscall.IPPROTO_VRRP", syscall.IPPROTO_VRRP)
	...
	_register("syscall.IP_EF", syscall.IP_EF)
	_register("syscall.IP_ERRORMTU", syscall.IP_ERRORMTU)
	...
	_register("syscall.IP_MINFRAGSIZE", syscall.IP_MINFRAGSIZE)
	...
	_register("syscall.MADV_SPACEAVAIL", syscall.MADV_SPACEAVAIL)
	_register("syscall.MADV_WILLNEED", syscall.MADV_WILLNEED)
	_register("syscall.MAP_ALIGNMENT_16MB", syscall.MAP_ALIGNMENT_16MB)
	_register("syscall.MAP_ALIGNMENT_1TB", syscall.MAP_ALIGNMENT_1TB)
	_register("syscall.MAP_ALIGNMENT_256TB", syscall.MAP_ALIGNMENT_256TB)
	_register("syscall.MAP_ALIGNMENT_4GB", syscall.MAP_ALIGNMENT_4GB)
	_register("syscall.MAP_ALIGNMENT_64KB", syscall.MAP_ALIGNMENT_64KB)
	_register("syscall.MAP_ALIGNMENT_64PB", syscall.MAP_ALIGNMENT_64PB)
	...
	_register("syscall.MAP_INHERIT", syscall.MAP_INHERIT)
	_register("syscall.MAP_INHERIT_COPY", syscall.MAP_INHERIT_COPY)
	_register("syscall.MAP_INHERIT_DEFAULT", syscall.MAP_INHERIT_DEFAULT)
	_register("syscall.MAP_INHERIT_DONATE_COPY", syscall.MAP_INHERIT_DONATE_COPY)
	_register("syscall.MAP_INHERIT_NONE", syscall.MAP_INHERIT_NONE)
	_register("syscall.MAP_INHERIT_SHARE", syscall.MAP_INHERIT_SHARE)
	...
	_register("syscall.MAP_TRYFIXED", syscall.MAP_TRYFIXED)
	_register("syscall.MAP_WIRED", syscall.MAP_WIRED)
	_register("syscall.MCL_CURRENT", syscall.MCL_CURRENT)
	_register("syscall.MCL_FUTURE", syscall.MCL_FUTURE)
	_register("syscall.MSG_BCAST", syscall.MSG_BCAST)
	_register("syscall.MSG_CMSG_CLOEXEC", syscall.MSG_CMSG_CLOEXEC)
	_register("syscall.MSG_CONTROLMBUF", syscall.MSG_CONTROLMBUF)
	...
	_register("syscall.MSG_IOVUSRSPACE", syscall.MSG_IOVUSRSPACE)
	_register("syscall.MSG_LENUSRSPACE", syscall.MSG_LENUSRSPACE)
	_register("syscall.MSG_MCAST", syscall.MSG_MCAST)
	_register("syscall.MSG_NAMEMBUF", syscall.MSG_NAMEMBUF)
	...
	_register("syscall.MSG_USERFLAGS", syscall.MSG_USERFLAGS)
	...
	_register("syscall.Mclpool", reflect.TypeOf((*syscall.Mclpool)(nil)).Elem())
	...
	_register("syscall.NET_RT_OIFLIST", syscall.NET_RT_OIFLIST)
	_register("syscall.NET_RT_OOIFLIST", syscall.NET_RT_OOIFLIST)
	...
	_register("syscall.OFIOGETBMAP", syscall.OFIOGETBMAP)
	...
	_register("syscall.O_ALT_IO", syscall.O_ALT_IO)
	...
	_register("syscall.O_NOSIGPIPE", syscall.O_NOSIGPIPE)
	...
	_register("syscall.PRI_IOFLUSH", syscall.PRI_IOFLUSH)
	...
	_register("syscall.RTAX_TAG", syscall.RTAX_TAG)
	...
	_register("syscall.RTA_TAG", syscall.RTA_TAG)
	_register("syscall.RTF_ANNOUNCE", syscall.RTF_ANNOUNCE)
	_register("syscall.RTF_BLACKHOLE", syscall.RTF_BLACKHOLE)
	_register("syscall.RTF_CLONED", syscall.RTF_CLONED)
	...
	_register("syscall.RTF_MASK", syscall.RTF_MASK)
	...
	_register("syscall.RTF_SRC", syscall.RTF_SRC)
	...
	_register("syscall.RTM_CHGADDR", syscall.RTM_CHGADDR)
	...
	_register("syscall.RTM_LLINFO_UPD", syscall.RTM_LLINFO_UPD)
	...
	_register("syscall.RTM_OIFINFO", syscall.RTM_OIFINFO)
	_register("syscall.RTM_OLDADD", syscall.RTM_OLDADD)
	_register("syscall.RTM_OLDDEL", syscall.RTM_OLDDEL)
	_register("syscall.RTM_OOIFINFO", syscall.RTM_OOIFINFO)
	...
	_register("syscall.RTM_SETGATE", syscall.RTM_SETGATE)
	...
	_register("syscall.SIOCGETPFSYNC", syscall.SIOCGETPFSYNC)
	...
	_register("syscall.SIOCGIFADDRPREF", syscall.SIOCGIFADDRPREF)
	_register("syscall.SIOCGIFALIAS", syscall.SIOCGIFALIAS)
	...
	_register("syscall.SIOCGIFDATA", syscall.SIOCGIFDATA)
	_register("syscall.SIOCGIFDLT", syscall.SIOCGIFDLT)
	...
	_register("syscall.SIOCSLINKSTR", syscall.SIOCSLINKSTR)
	_register("syscall.SIOCSLOWAT", syscall.SIOCSLOWAT)
	_register("syscall.SIOCSPGRP", syscall.SIOCSPGRP)
	_register("syscall.SIOCSVH", syscall.SIOCSVH)
	_register("syscall.SIOCZIFDATA", syscall.SIOCZIFDATA)
	_register("syscall.SOCK_CLOEXEC", syscall.SOCK_CLOEXEC)
	_register("syscall.SOCK_DGRAM", syscall.SOCK_DGRAM)
	_register("syscall.SOCK_FLAGS_MASK", syscall.SOCK_FLAGS_MASK)
	_register("syscall.SOCK_NONBLOCK", syscall.SOCK_NONBLOCK)
	_register("syscall.SOCK_NOSIGPIPE", syscall.SOCK_NOSIGPIPE)
	...
	_register("syscall.SO_NOHEADER", syscall.SO_NOHEADER)
	_register("syscall.SO_NOSIGPIPE", syscall.SO_NOSIGPIPE)
	_register("syscall.SO_OOBINLINE", syscall.SO_OOBINLINE)
	_register("syscall.SO_OVERFLOWED", syscall.SO_OVERFLOWED)
	...
	_register("syscall.SYSCTL_VERSION", syscall.SYSCTL_VERSION)
	_register("syscall.SYSCTL_VERS_0", syscall.SYSCTL_VERS_0)
	_register("syscall.SYSCTL_VERS_1", syscall.SYSCTL_VERS_1)
	_register("syscall.SYSCTL_VERS_MASK", syscall.SYSCTL_VERS_MASK)
	...
	_register("syscall.SYS_FCHROOT", syscall.SYS_FCHROOT)
	...
	_register("syscall.SYS_FKTRACE", syscall.SYS_FKTRACE)
	...
	_register("syscall.SYS_FSTATVFS1", syscall.SYS_FSTATVFS1)
	_register("syscall.SYS_FSYNC", syscall.SYS_FSYNC)
	_register("syscall.SYS_FSYNC_RANGE", syscall.SYS_FSYNC_RANGE)
	_register("syscall.SYS_FTRUNCATE", syscall.SYS_FTRUNCATE)
	_register("syscall.SYS_FUTIMENS", syscall.SYS_FUTIMENS)
	...
	_register("syscall.SYS_GETVFSSTAT", syscall.SYS_GETVFSSTAT)
	...
	_register("syscall.SYS_KQUEUE1", syscall.SYS_KQUEUE1)
	...
	_register("syscall.SYS_MODCTL", syscall.SYS_MODCTL)
	...
	_register("syscall.SYS_PACCEPT", syscall.SYS_PACCEPT)
	...
	_register("syscall.SYS_PMC_CONTROL", syscall.SYS_PMC_CONTROL)
	_register("syscall.SYS_PMC_GET_INFO", syscall.SYS_PMC_GET_INFO)
	_register("syscall.SYS_POLL", syscall.SYS_POLL)
	_register("syscall.SYS_POLLTS", syscall.SYS_POLLTS)
	...
	_register("syscall.SYS_PSET_ASSIGN", syscall.SYS_PSET_ASSIGN)
	_register("syscall.SYS_PSET_CREATE", syscall.SYS_PSET_CREATE)
	_register("syscall.SYS_PSET_DESTROY", syscall.SYS_PSET_DESTROY)
	...
	_register("syscall.SYS_RASCTL", syscall.SYS_RASCTL)
	...
	_register("syscall.SYS_SEMCONFIG", syscall.SYS_SEMCONFIG)
	...
	_register("syscall.SYS_SIGQUEUEINFO", syscall.SYS_SIGQUEUEINFO)
	...
	_register("syscall.SYS_STATVFS1", syscall.SYS_STATVFS1)
	_register("syscall.SYS_SWAPCTL", syscall.SYS_SWAPCTL)
	...
	_register("syscall.SYS_VADVISE", syscall.SYS_VADVISE)
	...
	_register("syscall.SYS__LWP_CONTINUE", syscall.SYS__LWP_CONTINUE)
	_register("syscall.SYS__LWP_CREATE", syscall.SYS__LWP_CREATE)
	_register("syscall.SYS__LWP_CTL", syscall.SYS__LWP_CTL)
	_register("syscall.SYS__LWP_DETACH", syscall.SYS__LWP_DETACH)
	_register("syscall.SYS__LWP_EXIT", syscall.SYS__LWP_EXIT)
	_register("syscall.SYS__LWP_GETNAME", syscall.SYS__LWP_GETNAME)
	_register("syscall.SYS__LWP_GETPRIVATE", syscall.SYS__LWP_GETPRIVATE)
	_register("syscall.SYS__LWP_KILL", syscall.SYS__LWP_KILL)
	_register("syscall.SYS__LWP_PARK", syscall.SYS__LWP_PARK)
	_register("syscall.SYS__LWP_SELF", syscall.SYS__LWP_SELF)
	_register("syscall.SYS__LWP_SETNAME", syscall.SYS__LWP_SETNAME)
	_register("syscall.SYS__LWP_SETPRIVATE", syscall.SYS__LWP_SETPRIVATE)
	_register("syscall.SYS__LWP_SUSPEND", syscall.SYS__LWP_SUSPEND)
	_register("syscall.SYS__LWP_UNPARK", syscall.SYS__LWP_UNPARK)
	_register("syscall.SYS__LWP_UNPARK_ALL", syscall.SYS__LWP_UNPARK_ALL)
	_register("syscall.SYS__LWP_WAIT", syscall.SYS__LWP_WAIT)
	_register("syscall.SYS__LWP_WAKEUP", syscall.SYS__LWP_WAKEUP)
	_register("syscall.SYS__PSET_BIND", syscall.SYS__PSET_BIND)
	_register("syscall.SYS__SCHED_GETAFFINITY", syscall.SYS__SCHED_GETAFFINITY)
	_register("syscall.SYS__SCHED_GETPARAM", syscall.SYS__SCHED_GETPARAM)
	_register("syscall.SYS__SCHED_SETAFFINITY", syscall.SYS__SCHED_SETAFFINITY)
	_register("syscall.SYS__SCHED_SETPARAM", syscall.SYS__SCHED_SETPARAM)
	_register("syscall.SYS___CLONE", syscall.SYS___CLONE)
	_register("syscall.SYS___GETCWD", syscall.SYS___GETCWD)
	_register("syscall.SYS___GETLOGIN", syscall.SYS___GETLOGIN)
	_register("syscall.SYS___POSIX_CHOWN", syscall.SYS___POSIX_CHOWN)
	_register("syscall.SYS___POSIX_FCHOWN", syscall.SYS___POSIX_FCHOWN)
	_register("syscall.SYS___POSIX_LCHOWN", syscall.SYS___POSIX_LCHOWN)
	_register("syscall.SYS___POSIX_RENAME", syscall.SYS___POSIX_RENAME)
	_register("syscall.SYS___QUOTACTL", syscall.SYS___QUOTACTL)
	_register("syscall.SYS___SEMCTL", syscall.SYS___SEMCTL)
	_register("syscall.SYS___SETLOGIN", syscall.SYS___SETLOGIN)
	_register("syscall.SYS___SIGACTION_SIGTRAMP", syscall.SYS___SIGACTION_SIGTRAMP)
	_register("syscall.SYS___SIGTIMEDWAIT", syscall.SYS___SIGTIMEDWAIT)
	_register("syscall.SYS___SYSCTL", syscall.SYS___SYSCTL)
	_register("syscall.S_ARCH1", syscall.S_ARCH1)
	_register("syscall.S_ARCH2", syscall.S_ARCH2)
	...
	_register("syscall.S_LOGIN_SET", syscall.S_LOGIN_SET)
	...
	_register("syscall.Sysctlnode", reflect.TypeOf((*syscall.Sysctlnode)(nil)).Elem())
	_register("syscall.*Sysctlnode", reflect.TypeOf((*syscall.Sysctlnode)(nil)))
	...
	_register("syscall.TCP_CONGCTL", syscall.TCP_CONGCTL)
	...
	_register("syscall.TIOCFLAG_CDTRCTS", syscall.TIOCFLAG_CDTRCTS)
	_register("syscall.TIOCFLAG_CLOCAL", syscall.TIOCFLAG_CLOCAL)
	_register("syscall.TIOCFLAG_CRTSCTS", syscall.TIOCFLAG_CRTSCTS)
	_register("syscall.TIOCFLAG_MDMBUF", syscall.TIOCFLAG_MDMBUF)
	_register("syscall.TIOCFLAG_SOFTCAR", syscall.TIOCFLAG_SOFTCAR)
	...
	_register("syscall.TIOCGFLAGS", syscall.TIOCGFLAGS)
	_register("syscall.TIOCGLINED", syscall.TIOCGLINED)
	_register("syscall.TIOCGPGRP", syscall.TIOCGPGRP)
	_register("syscall.TIOCGQSIZE", syscall.TIOCGQSIZE)
	_register("syscall.TIOCGRANTPT", syscall.TIOCGRANTPT)
	_register("syscall.TIOCGSID", syscall.TIOCGSID)
	_register("syscall.TIOCGSIZE", syscall.TIOCGSIZE)
	...
	_register("syscall.TIOCPTMGET", syscall.TIOCPTMGET)
	_register("syscall.TIOCPTSNAME", syscall.TIOCPTSNAME)
	_register("syscall.TIOCRCVFRAME", syscall.TIOCRCVFRAME)
	...
	_register("syscall.TIOCSFLAGS", syscall.TIOCSFLAGS)
	_register("syscall.TIOCSIG", syscall.TIOCSIG)
	_register("syscall.TIOCSLINED", syscall.TIOCSLINED)
	_register("syscall.TIOCSPGRP", syscall.TIOCSPGRP)
	_register("syscall.TIOCSQSIZE", syscall.TIOCSQSIZE)
	_register("syscall.TIOCSSIZE", syscall.TIOCSSIZE)
	...
	_register("syscall.TIOCXMTFRAME", syscall.TIOCXMTFRAME)
	...
	_register("syscall.WALLSIG", syscall.WALLSIG)
	_register("syscall.WALTSIG", syscall.WALTSIG)
	...
	_register("syscall.WNOZOMBIE", syscall.WNOZOMBIE)
	_register("syscall.WOPTSCHECKED", syscall.WOPTSCHECKED)
