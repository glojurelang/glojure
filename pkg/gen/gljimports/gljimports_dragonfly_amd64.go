...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("syscall.BPF_DEFAULTBUFSIZE", syscall.BPF_DEFAULTBUFSIZE)
	...
	_register("syscall.BPF_MAX_CLONES", syscall.BPF_MAX_CLONES)
	...
	_register("syscall.DLT_REDBACK_SMARTEDGE", syscall.DLT_REDBACK_SMARTEDGE)
	...
	_register("syscall.DT_DBF", syscall.DT_DBF)
	...
	_register("syscall.EASYNC", syscall.EASYNC)
	...
	_register("syscall.EUNUSED94", syscall.EUNUSED94)
	_register("syscall.EUNUSED95", syscall.EUNUSED95)
	_register("syscall.EUNUSED96", syscall.EUNUSED96)
	_register("syscall.EUNUSED97", syscall.EUNUSED97)
	_register("syscall.EUNUSED98", syscall.EUNUSED98)
	_register("syscall.EUSERS", syscall.EUSERS)
	_register("syscall.EVFILT_AIO", syscall.EVFILT_AIO)
	_register("syscall.EVFILT_EXCEPT", syscall.EVFILT_EXCEPT)
	_register("syscall.EVFILT_MARKER", syscall.EVFILT_MARKER)
	...
	_register("syscall.EV_NODATA", syscall.EV_NODATA)
	...
	_register("syscall.EXTEXIT_LWP", syscall.EXTEXIT_LWP)
	_register("syscall.EXTEXIT_PROC", syscall.EXTEXIT_PROC)
	_register("syscall.EXTEXIT_SETINT", syscall.EXTEXIT_SETINT)
	_register("syscall.EXTEXIT_SIMPLE", syscall.EXTEXIT_SIMPLE)
	...
	_register("syscall.IFF_NPOLLING", syscall.IFF_NPOLLING)
	_register("syscall.IFF_OACTIVE", syscall.IFF_OACTIVE)
	_register("syscall.IFF_OACTIVE_COMPAT", syscall.IFF_OACTIVE_COMPAT)
	_register("syscall.IFF_POINTOPOINT", syscall.IFF_POINTOPOINT)
	_register("syscall.IFF_POLLING", syscall.IFF_POLLING)
	_register("syscall.IFF_POLLING_COMPAT", syscall.IFF_POLLING_COMPAT)
	...
	_register("syscall.IPPROTO_UNKNOWN", syscall.IPPROTO_UNKNOWN)
	...
	_register("syscall.IPV6_PKTOPTIONS", syscall.IPV6_PKTOPTIONS)
	...
	_register("syscall.MADV_CONTROL_END", syscall.MADV_CONTROL_END)
	_register("syscall.MADV_CONTROL_START", syscall.MADV_CONTROL_START)
	...
	_register("syscall.MADV_INVAL", syscall.MADV_INVAL)
	...
	_register("syscall.MADV_SETMAP", syscall.MADV_SETMAP)
	...
	_register("syscall.MAP_SIZEALIGN", syscall.MAP_SIZEALIGN)
	_register("syscall.MAP_STACK", syscall.MAP_STACK)
	_register("syscall.MAP_TRYFIXED", syscall.MAP_TRYFIXED)
	_register("syscall.MAP_VPAGETABLE", syscall.MAP_VPAGETABLE)
	...
	_register("syscall.MSG_FBLOCKING", syscall.MSG_FBLOCKING)
	_register("syscall.MSG_FMASK", syscall.MSG_FMASK)
	_register("syscall.MSG_FNONBLOCKING", syscall.MSG_FNONBLOCKING)
	...
	_register("syscall.MSG_SYNC", syscall.MSG_SYNC)
	...
	_register("syscall.NOTE_OOB", syscall.NOTE_OOB)
	...
	_register("syscall.O_FAPPEND", syscall.O_FAPPEND)
	_register("syscall.O_FASYNCWRITE", syscall.O_FASYNCWRITE)
	_register("syscall.O_FBLOCKING", syscall.O_FBLOCKING)
	_register("syscall.O_FBUFFERED", syscall.O_FBUFFERED)
	_register("syscall.O_FMASK", syscall.O_FMASK)
	_register("syscall.O_FNONBLOCKING", syscall.O_FNONBLOCKING)
	_register("syscall.O_FOFFSET", syscall.O_FOFFSET)
	_register("syscall.O_FSYNC", syscall.O_FSYNC)
	_register("syscall.O_FSYNCWRITE", syscall.O_FSYNCWRITE)
	_register("syscall.O_FUNBUFFERED", syscall.O_FUNBUFFERED)
	_register("syscall.O_MAPONREAD", syscall.O_MAPONREAD)
	...
	_register("syscall.RTAX_MPLS1", syscall.RTAX_MPLS1)
	_register("syscall.RTAX_MPLS2", syscall.RTAX_MPLS2)
	_register("syscall.RTAX_MPLS3", syscall.RTAX_MPLS3)
	...
	_register("syscall.RTA_MPLS1", syscall.RTA_MPLS1)
	_register("syscall.RTA_MPLS2", syscall.RTA_MPLS2)
	_register("syscall.RTA_MPLS3", syscall.RTA_MPLS3)
	...
	_register("syscall.RTF_MPLSOPS", syscall.RTF_MPLSOPS)
	...
	_register("syscall.RTV_IWCAPSEGS", syscall.RTV_IWCAPSEGS)
	_register("syscall.RTV_IWMAXSEGS", syscall.RTV_IWMAXSEGS)
	_register("syscall.RTV_MSL", syscall.RTV_MSL)
	...
	_register("syscall.SIGCKPT", syscall.SIGCKPT)
	_register("syscall.SIGCKPTEXIT", syscall.SIGCKPTEXIT)
	...
	_register("syscall.SIOCSIFPOLLCPU", syscall.SIOCSIFPOLLCPU)
	_register("syscall.SIOCSIFTSOLEN", syscall.SIOCSIFTSOLEN)
	...
	_register("syscall.SO_SNDSPACE", syscall.SO_SNDSPACE)
	...
	_register("syscall.SYS_CHROOT_KERNEL", syscall.SYS_CHROOT_KERNEL)
	...
	_register("syscall.SYS_EXEC_SYS_REGISTER", syscall.SYS_EXEC_SYS_REGISTER)
	_register("syscall.SYS_EXEC_SYS_UNREGISTER", syscall.SYS_EXEC_SYS_UNREGISTER)
	_register("syscall.SYS_EXIT", syscall.SYS_EXIT)
	_register("syscall.SYS_EXTACCEPT", syscall.SYS_EXTACCEPT)
	...
	_register("syscall.SYS_EXTCONNECT", syscall.SYS_EXTCONNECT)
	_register("syscall.SYS_EXTEXIT", syscall.SYS_EXTEXIT)
	_register("syscall.SYS_EXTPREAD", syscall.SYS_EXTPREAD)
	_register("syscall.SYS_EXTPREADV", syscall.SYS_EXTPREADV)
	_register("syscall.SYS_EXTPWRITE", syscall.SYS_EXTPWRITE)
	_register("syscall.SYS_EXTPWRITEV", syscall.SYS_EXTPWRITEV)
	...
	_register("syscall.SYS_FHSTATVFS", syscall.SYS_FHSTATVFS)
	...
	_register("syscall.SYS_FSTATVFS", syscall.SYS_FSTATVFS)
	...
	_register("syscall.SYS_GETDOMAINNAME", syscall.SYS_GETDOMAINNAME)
	...
	_register("syscall.SYS_GET_TLS_AREA", syscall.SYS_GET_TLS_AREA)
	...
	_register("syscall.SYS_LWP_CREATE", syscall.SYS_LWP_CREATE)
	_register("syscall.SYS_LWP_GETTID", syscall.SYS_LWP_GETTID)
	_register("syscall.SYS_LWP_KILL", syscall.SYS_LWP_KILL)
	_register("syscall.SYS_LWP_RTPRIO", syscall.SYS_LWP_RTPRIO)
	_register("syscall.SYS_MADVISE", syscall.SYS_MADVISE)
	_register("syscall.SYS_MCONTROL", syscall.SYS_MCONTROL)
	...
	_register("syscall.SYS_MOUNTCTL", syscall.SYS_MOUNTCTL)
	_register("syscall.SYS_MPROTECT", syscall.SYS_MPROTECT)
	_register("syscall.SYS_MQ_CLOSE", syscall.SYS_MQ_CLOSE)
	_register("syscall.SYS_MQ_GETATTR", syscall.SYS_MQ_GETATTR)
	_register("syscall.SYS_MQ_NOTIFY", syscall.SYS_MQ_NOTIFY)
	_register("syscall.SYS_MQ_OPEN", syscall.SYS_MQ_OPEN)
	_register("syscall.SYS_MQ_RECEIVE", syscall.SYS_MQ_RECEIVE)
	_register("syscall.SYS_MQ_SEND", syscall.SYS_MQ_SEND)
	_register("syscall.SYS_MQ_SETATTR", syscall.SYS_MQ_SETATTR)
	...
	_register("syscall.SYS_SET_TLS_AREA", syscall.SYS_SET_TLS_AREA)
	...
	_register("syscall.SYS_STATVFS", syscall.SYS_STATVFS)
	...
	_register("syscall.SYS_SYS_CHECKPOINT", syscall.SYS_SYS_CHECKPOINT)
	_register("syscall.SYS_TRUNCATE", syscall.SYS_TRUNCATE)
	_register("syscall.SYS_UMASK", syscall.SYS_UMASK)
	_register("syscall.SYS_UMTX_SLEEP", syscall.SYS_UMTX_SLEEP)
	_register("syscall.SYS_UMTX_WAKEUP", syscall.SYS_UMTX_WAKEUP)
	...
	_register("syscall.SYS_USCHED_SET", syscall.SYS_USCHED_SET)
	...
	_register("syscall.SYS_VARSYM_GET", syscall.SYS_VARSYM_GET)
	_register("syscall.SYS_VARSYM_LIST", syscall.SYS_VARSYM_LIST)
	_register("syscall.SYS_VARSYM_SET", syscall.SYS_VARSYM_SET)
	_register("syscall.SYS_VFORK", syscall.SYS_VFORK)
	_register("syscall.SYS_VMM_GUEST_CTL", syscall.SYS_VMM_GUEST_CTL)
	_register("syscall.SYS_VMM_GUEST_SYNC_ADDR", syscall.SYS_VMM_GUEST_SYNC_ADDR)
	_register("syscall.SYS_VMSPACE_CREATE", syscall.SYS_VMSPACE_CREATE)
	_register("syscall.SYS_VMSPACE_CTL", syscall.SYS_VMSPACE_CTL)
	_register("syscall.SYS_VMSPACE_DESTROY", syscall.SYS_VMSPACE_DESTROY)
	_register("syscall.SYS_VMSPACE_MCONTROL", syscall.SYS_VMSPACE_MCONTROL)
	_register("syscall.SYS_VMSPACE_MMAP", syscall.SYS_VMSPACE_MMAP)
	_register("syscall.SYS_VMSPACE_MUNMAP", syscall.SYS_VMSPACE_MUNMAP)
	_register("syscall.SYS_VMSPACE_PREAD", syscall.SYS_VMSPACE_PREAD)
	_register("syscall.SYS_VMSPACE_PWRITE", syscall.SYS_VMSPACE_PWRITE)
	_register("syscall.SYS_VQUOTACTL", syscall.SYS_VQUOTACTL)
	...
	_register("syscall.TCP_FASTKEEP", syscall.TCP_FASTKEEP)
	...
	_register("syscall.TCP_MIN_WINSHIFT", syscall.TCP_MIN_WINSHIFT)
	...
	_register("syscall.TCP_SIGNATURE_ENABLE", syscall.TCP_SIGNATURE_ENABLE)
	...
	_register("syscall.TIOCISPTMASTER", syscall.TIOCISPTMASTER)
	...
	_register("syscall.VCHECKPT", syscall.VCHECKPT)
