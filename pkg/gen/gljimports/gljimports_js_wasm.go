...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("syscall.ECASECLASH", syscall.ECASECLASH)
	...
	_register("syscall.ELBIN", syscall.ELBIN)
	...
	_register("syscall.ENMFILE", syscall.ENMFILE)
	...
	_register("syscall.ENOSHARE", syscall.ENOSHARE)
