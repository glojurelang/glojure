...
func RegisterImports(_register func(string, interface{})) {
	...
	_register("syscall.PTRACE_ARCH_PRCTL", syscall.PTRACE_ARCH_PRCTL)
	...
	_register("syscall.SYS_ARCH_PRCTL", syscall.SYS_ARCH_PRCTL)
	...
	_register("syscall.SYS_EPOLL_CTL_OLD", syscall.SYS_EPOLL_CTL_OLD)
	_register("syscall.SYS_EPOLL_PWAIT", syscall.SYS_EPOLL_PWAIT)
	_register("syscall.SYS_EPOLL_WAIT", syscall.SYS_EPOLL_WAIT)
	_register("syscall.SYS_EPOLL_WAIT_OLD", syscall.SYS_EPOLL_WAIT_OLD)
	...
	_register("syscall.SYS_SECURITY", syscall.SYS_SECURITY)
