...
const pkg = "github.com/glojurelang/glojure/pkg/javacompat/character"
...
func register(jvmName, goName string, v any) {
	...
	pkgmap.SetHostClass("Character", lang.NewClass(reflect.TypeOf(lang.Char(0)), "java.lang.Character"))
}
