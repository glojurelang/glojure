...
func init() {
	runtime.RegisterNSLoader("glojure/walk", LoadNS)
}
...
// LoadNS initializes the namespace "glojure.walk"
func LoadNS() {
	...
	// var glojure.walk/keywordize-keys
	var_glojure_DOT_walk_keywordize_DASH_keys := lang.InternVarName(sym_glojure_DOT_walk, sym_keywordize_DASH_keys)
	// var glojure.walk/macroexpand-all
	var_glojure_DOT_walk_macroexpand_DASH_all := lang.InternVarName(sym_glojure_DOT_walk, sym_macroexpand_DASH_all)
	// var glojure.walk/postwalk
	var_glojure_DOT_walk_postwalk := lang.InternVarName(sym_glojure_DOT_walk, sym_postwalk)
	// var glojure.walk/postwalk-demo
	var_glojure_DOT_walk_postwalk_DASH_demo := lang.InternVarName(sym_glojure_DOT_walk, sym_postwalk_DASH_demo)
	...
	// var glojure.walk/prewalk
	var_glojure_DOT_walk_prewalk := lang.InternVarName(sym_glojure_DOT_walk, sym_prewalk)
	// var glojure.walk/prewalk-demo
	var_glojure_DOT_walk_prewalk_DASH_demo := lang.InternVarName(sym_glojure_DOT_walk, sym_prewalk_DASH_demo)
	// var glojure.walk/prewalk-replace
	var_glojure_DOT_walk_prewalk_DASH_replace := lang.InternVarName(sym_glojure_DOT_walk, sym_prewalk_DASH_replace)
	// var glojure.walk/stringify-keys
	var_glojure_DOT_walk_stringify_DASH_keys := lang.InternVarName(sym_glojure_DOT_walk, sym_stringify_DASH_keys)
	// var glojure.walk/walk
	var_glojure_DOT_walk_walk := lang.InternVarName(sym_glojure_DOT_walk, sym_walk)
	// reference fmt to avoid unused import error
	_ = fmt.Printf
	// reference reflect to avoid unused import error
	_ = reflect.TypeOf
	ns := lang.FindOrCreateNamespace(sym_glojure_DOT_walk)
	_ = ns
	// keywordize-keys
	{
		tmp0 := sym_keywordize_DASH_keys.WithMeta(lang.NewMap(kw_arglists, lang.NewList(lang.NewVector(sym_m)), kw_doc, "Recursively transforms all map keys from strings to keywords.", kw_file, "glojure/walk.glj", kw_added, "1.1", kw_ns, lang.FindOrCreateNamespace(sym_glojure_DOT_walk), kw_end_DASH_column, int(21), kw_column, int(7), kw_line, int(83), kw_end_DASH_line, int(83))).(*lang.Symbol)
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			{ // let
				...
				tmp4 = lang.NewFnFunc(func(args ...any) any {
					...
					{ // let
						...
						if lang.IsTruthy(tmp16) {
							...
							tmp20 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(87), kw_column, int(39), kw_end_DASH_line, int(87), kw_end_DASH_column, int(53))
							...
							tmp23 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(87), kw_column, int(55), kw_end_DASH_line, int(87), kw_end_DASH_column, int(59))
				...
				tmp5 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(87), kw_column, int(11), kw_end_DASH_line, int(87), kw_end_DASH_column, int(61))
				...
				var v7 any = tmp6
				_ = v7
				tmp8 := checkDerefVar(var_glojure_DOT_walk_postwalk)
				...
				tmp9 = lang.NewFnFunc(func(args ...any) any {
					...
					_ = v10
					var tmp11 any
					tmp12 := checkDerefVar(var_glojure_DOT_core_map_QMARK_)
					tmp13 := lang.Apply(tmp12, []any{v10})
					if lang.IsTruthy(tmp13) {
						tmp14 := checkDerefVar(var_glojure_DOT_core_into)
						tmp15 := lang.NewMap()
						tmp16 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(89), kw_column, int(42), kw_end_DASH_line, int(89), kw_end_DASH_column, int(43))
				...
				tmp10 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(89), kw_column, int(15), kw_end_DASH_line, int(89), kw_end_DASH_column, int(58))
		...
		var_glojure_DOT_walk_keywordize_DASH_keys = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_glojure_DOT_walk_keywordize_DASH_keys.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// macroexpand-all
	{
		tmp0 := sym_macroexpand_DASH_all.WithMeta(lang.NewMap(kw_arglists, lang.NewList(lang.NewVector(sym_form)), kw_doc, "Recursively performs all possible macroexpansions in form.", kw_file, "glojure/walk.glj", kw_added, "1.1", kw_ns, lang.FindOrCreateNamespace(sym_glojure_DOT_walk), kw_end_DASH_column, int(21), kw_column, int(7), kw_line, int(115), kw_end_DASH_line, int(115))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
			_ = v2
			tmp3 := checkDerefVar(var_glojure_DOT_walk_prewalk)
			var tmp4 lang.FnFunc
			tmp4 = lang.NewFnFunc(func(args ...any) any {
				checkArity(args, 1)
				v5 := args[0]
				...
				if lang.IsTruthy(tmp8) {
					tmp9 := checkDerefVar(var_glojure_DOT_core_macroexpand)
			...
			tmp5 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(119), kw_column, int(12), kw_end_DASH_line, int(119), kw_end_DASH_column, int(51))
			tmp6, err := lang.WithMeta(tmp4, tmp5.(lang.IPersistentMap))
			if err != nil {
				panic(err)
			}
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_glojure_DOT_walk_macroexpand_DASH_all = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_glojure_DOT_walk_macroexpand_DASH_all.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// postwalk
	{
		tmp0 := sym_postwalk.WithMeta(lang.NewMap(kw_arglists, lang.NewList(lang.NewVector(sym_f, sym_form)), kw_doc, "Performs a depth-first, post-order traversal of form.  Calls f on\n  each sub-form, uses f's return value in place of the original.\n  Recognizes all Clojure data structures. Consumes seqs as with doall.", kw_file, "glojure/walk.glj", kw_added, "1.1", kw_ns, lang.FindOrCreateNamespace(sym_glojure_DOT_walk), kw_end_DASH_column, int(14), kw_column, int(7), kw_line, int(42), kw_end_DASH_line, int(42))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 2)
			v2 := args[0]
			...
			v3 := args[1]
			_ = v3
			tmp4 := checkDerefVar(var_glojure_DOT_walk_walk)
			tmp5 := checkDerefVar(var_glojure_DOT_core_partial)
			tmp6 := checkDerefVar(var_glojure_DOT_walk_postwalk)
			tmp7 := lang.Apply(tmp5, []any{tmp6, v2})
			tmp8 := lang.Apply(tmp4, []any{tmp7, v2, v3})
			return tmp8
		})
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_glojure_DOT_walk_postwalk = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_glojure_DOT_walk_postwalk.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// postwalk-demo
	{
		tmp0 := sym_postwalk_DASH_demo.WithMeta(lang.NewMap(kw_arglists, lang.NewList(lang.NewVector(sym_form)), kw_doc, "Demonstrates the behavior of postwalk by printing each form as it is\n  walked.  Returns form.", kw_file, "glojure/walk.glj", kw_added, "1.1", kw_ns, lang.FindOrCreateNamespace(sym_glojure_DOT_walk), kw_end_DASH_column, int(19), kw_column, int(7), kw_line, int(69), kw_end_DASH_line, int(69))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
			_ = v2
			tmp3 := checkDerefVar(var_glojure_DOT_walk_postwalk)
			var tmp4 lang.FnFunc
			tmp4 = lang.NewFnFunc(func(args ...any) any {
				checkArity(args, 1)
				v5 := args[0]
				_ = v5
				tmp6 := checkDerefVar(var_glojure_DOT_core_print)
				tmp7 := lang.Apply(tmp6, []any{"Walked: "})
				_ = tmp7
				tmp8 := checkDerefVar(var_glojure_DOT_core_prn)
				tmp9 := lang.Apply(tmp8, []any{v5})
				_ = tmp9
				return v5
			})
			tmp5 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(74), kw_column, int(13), kw_end_DASH_line, int(74), kw_end_DASH_column, int(49))
			tmp6, err := lang.WithMeta(tmp4, tmp5.(lang.IPersistentMap))
			if err != nil {
				panic(err)
			}
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_glojure_DOT_walk_postwalk_DASH_demo = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_glojure_DOT_walk_postwalk_DASH_demo.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// postwalk-replace
	{
		tmp0 := sym_postwalk_DASH_replace.WithMeta(lang.NewMap(kw_arglists, lang.NewList(lang.NewVector(sym_smap, sym_form)), kw_doc, "Recursively transforms form by replacing keys in smap with their\n  values.  Like glojure/replace but works on any data structure.  Does\n  replacement at the leaves of the tree first.", kw_file, "glojure/walk.glj", kw_added, "1.1", kw_ns, lang.FindOrCreateNamespace(sym_glojure_DOT_walk), kw_end_DASH_column, int(22), kw_column, int(7), kw_line, int(107), kw_end_DASH_line, int(107))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 2)
			v2 := args[0]
			...
			v3 := args[1]
			_ = v3
			tmp4 := checkDerefVar(var_glojure_DOT_walk_postwalk)
			...
			tmp5 = lang.NewFnFunc(func(args ...any) any {
				...
				_ = v6
				var tmp7 any
				tmp8 := checkDerefVar(var_glojure_DOT_core_contains_QMARK_)
			...
			tmp6 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(113), kw_column, int(13), kw_end_DASH_line, int(113), kw_end_DASH_column, int(55))
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_glojure_DOT_walk_postwalk_DASH_replace = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_glojure_DOT_walk_postwalk_DASH_replace.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// prewalk
	{
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			tmp4 := checkDerefVar(var_glojure_DOT_walk_walk)
			tmp5 := checkDerefVar(var_glojure_DOT_core_partial)
			tmp6 := checkDerefVar(var_glojure_DOT_walk_prewalk)
			tmp7 := lang.Apply(tmp5, []any{tmp6, v2})
			tmp8 := checkDerefVar(var_glojure_DOT_core_identity)
			tmp9 := lang.Apply(v2, []any{v3})
			tmp10 := lang.Apply(tmp4, []any{tmp7, tmp8, tmp9})
			return tmp10
		})
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_glojure_DOT_walk_prewalk = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_glojure_DOT_walk_prewalk.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// prewalk-demo
	{
		tmp0 := sym_prewalk_DASH_demo.WithMeta(lang.NewMap(kw_arglists, lang.NewList(lang.NewVector(sym_form)), kw_doc, "Demonstrates the behavior of prewalk by printing each form as it is\n  walked.  Returns form.", kw_file, "glojure/walk.glj", kw_added, "1.1", kw_ns, lang.FindOrCreateNamespace(sym_glojure_DOT_walk), kw_end_DASH_column, int(18), kw_column, int(7), kw_line, int(76), kw_end_DASH_line, int(76))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
			...
			tmp5 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(81), kw_column, int(12), kw_end_DASH_line, int(81), kw_end_DASH_column, int(48))
			tmp6, err := lang.WithMeta(tmp4, tmp5.(lang.IPersistentMap))
			if err != nil {
				panic(err)
			}
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_glojure_DOT_walk_prewalk_DASH_demo = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_glojure_DOT_walk_prewalk_DASH_demo.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// prewalk-replace
	{
		tmp0 := sym_prewalk_DASH_replace.WithMeta(lang.NewMap(kw_arglists, lang.NewList(lang.NewVector(sym_smap, sym_form)), kw_doc, "Recursively transforms form by replacing keys in smap with their\n  values.  Like glojure/replace but works on any data structure.  Does\n  replacement at the root of the tree first.", kw_file, "glojure/walk.glj", kw_added, "1.1", kw_ns, lang.FindOrCreateNamespace(sym_glojure_DOT_walk), kw_end_DASH_column, int(21), kw_column, int(7), kw_line, int(99), kw_end_DASH_line, int(99))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 2)
			v2 := args[0]
			...
			v3 := args[1]
			_ = v3
			tmp4 := checkDerefVar(var_glojure_DOT_walk_prewalk)
			var tmp5 lang.FnFunc
			tmp5 = lang.NewFnFunc(func(args ...any) any {
				checkArity(args, 1)
				v6 := args[0]
			...
			tmp6 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(105), kw_column, int(12), kw_end_DASH_line, int(105), kw_end_DASH_column, int(54))
			tmp7, err := lang.WithMeta(tmp5, tmp6.(lang.IPersistentMap))
			if err != nil {
				panic(err)
			}
	...
	// stringify-keys
	{
			...
			{ // let
				...
				tmp4 = lang.NewFnFunc(func(args ...any) any {
					...
					{ // let
						...
						tmp16 := lang.Apply(tmp15, []any{v10})
						if lang.IsTruthy(tmp16) {
							tmp17 := checkDerefVar(var_glojure_DOT_core_name)
							tmp18 := lang.Apply(tmp17, []any{v10})
							tmp19 := lang.NewVector(tmp18, v13)
							tmp20 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(95), kw_column, int(40), kw_end_DASH_line, int(95), kw_end_DASH_column, int(51))
							tmp21, err := lang.WithMeta(tmp19, tmp20.(lang.IPersistentMap))
							if err != nil {
								panic(err)
							}
							...
							tmp22 := lang.NewVector(v10, v13)
							tmp23 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(95), kw_column, int(53), kw_end_DASH_line, int(95), kw_end_DASH_column, int(57))
							tmp24, err := lang.WithMeta(tmp22, tmp23.(lang.IPersistentMap))
							if err != nil {
								panic(err)
							}
				...
				tmp5 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(95), kw_column, int(11), kw_end_DASH_line, int(95), kw_end_DASH_column, int(59))
				tmp6, err := lang.WithMeta(tmp4, tmp5.(lang.IPersistentMap))
				if err != nil {
					panic(err)
				}
				...
				tmp9 = lang.NewFnFunc(func(args ...any) any {
					...
					if lang.IsTruthy(tmp13) {
						tmp14 := checkDerefVar(var_glojure_DOT_core_into)
						tmp15 := lang.NewMap()
						tmp16 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(97), kw_column, int(42), kw_end_DASH_line, int(97), kw_end_DASH_column, int(43))
						tmp17, err := lang.WithMeta(tmp15, tmp16.(lang.IPersistentMap))
						if err != nil {
							panic(err)
						}
				...
				tmp10 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(97), kw_column, int(15), kw_end_DASH_line, int(97), kw_end_DASH_column, int(58))
				tmp11, err := lang.WithMeta(tmp9, tmp10.(lang.IPersistentMap))
				if err != nil {
					panic(err)
				}
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_glojure_DOT_walk_stringify_DASH_keys = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_glojure_DOT_walk_stringify_DASH_keys.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// walk
	{
		tmp0 := sym_walk.WithMeta(lang.NewMap(kw_arglists, lang.NewList(lang.NewVector(sym_inner, sym_outer, sym_form)), kw_doc, "Traverses form, an arbitrary data structure.  inner and outer are\n  functions.  Applies inner to each element of form, building up a\n  data structure of the same type, then applies outer to the result.\n  Recognizes all Clojure data structures. Consumes seqs as with doall.", kw_file, "glojure/walk.glj", kw_added, "1.1", kw_ns, lang.FindOrCreateNamespace(sym_glojure_DOT_walk), kw_end_DASH_column, int(10), kw_column, int(7), kw_line, int(24), kw_end_DASH_line, int(24))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 3)
			v2 := args[0]
			...
			_ = v4
			var tmp5 any
			tmp6 := checkDerefVar(var_glojure_DOT_core_list_QMARK_)
			...
			if lang.IsTruthy(tmp7) {
				...
				if lang.IsTruthy(tmp21) {
					...
					if lang.IsTruthy(tmp32) {
						...
						var tmp42 any
						tmp43 := checkDerefVar(var_glojure_DOT_core_instance_QMARK_)
						tmp44 := reflect.TypeOf((*lang.IRecord)(nil)).Elem()
						tmp45 := lang.Apply(tmp43, []any{tmp44, v4})
						if lang.IsTruthy(tmp45) {
							tmp46 := checkDerefVar(var_glojure_DOT_core_reduce)
							...
							tmp48 := lang.NewMap(kw_file, "glojure/walk.glj", kw_line, int(38), kw_column, int(21), kw_end_DASH_line, int(38), kw_end_DASH_column, int(49))
							...
							var tmp52 any
							tmp53 := checkDerefVar(var_glojure_DOT_core_coll_QMARK_)
							tmp54 := lang.Apply(tmp53, []any{v4})
							if lang.IsTruthy(tmp54) {
								tmp55 := checkDerefVar(var_glojure_DOT_core_into)
								tmp56 := checkDerefVar(var_glojure_DOT_core_empty)
								tmp57 := lang.Apply(tmp56, []any{v4})
								tmp58 := checkDerefVar(var_glojure_DOT_core_map)
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_glojure_DOT_walk_walk = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_glojure_DOT_walk_walk.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
}
