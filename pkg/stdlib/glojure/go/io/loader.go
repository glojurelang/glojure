...
func LoadNS() {
	...
	var closed9 any
	{
		...
		tmp0 = tmp0.WithMeta(lang.NewMap(kw_file, "glojure/go/io.glj", kw_line, int(245), kw_column, int(25), kw_end_DASH_line, int(248), kw_end_DASH_column, int(149))).(lang.FnFunc2)
		closed9 = tmp0
	}
	// IOFactory
	{
